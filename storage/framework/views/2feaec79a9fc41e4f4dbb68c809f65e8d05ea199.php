                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30"><?php echo $__env->make('common.error', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <form class="container" method="POST" action="<?php echo e(url('store_task')); ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control user_id" name="user_id" id="user_id" required>
                                                ...
                                                <?php $__currentLoopData = $facilitator_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mb-3 text-center">
                                            ...
                                            <a href="<?php echo e(url('preanalytics')); ?>" class="btn btn-sm btn-danger">Back</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/preanalytics/list_tasks.blade.php ENDPATH**/ ?>