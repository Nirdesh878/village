    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                <?php $session_data = Session::get('process_filter_session'); ?>
                ...
                <div class="page-header-title">
                    ...
                    <div class="pull-right">
                        ...
                        <div class="export_pdf_css">
                            <a href="<?php echo e(URL::to('processStepPdf')); ?>"><img src="<?php echo e(asset('assets\images\pdf.png')); ?>" data-toggle="tooltip" title="PDF Download" alt="PDF Download" title="PDF Download" class="lzy lazyload--done" style="height: 35px;"></a>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                         ...
                         <?php if(!empty($session_data['group'])): ?>
                            <div class="dt-responsive table-responsive">
                                ...
                                <table id="simpletable" class="table table-striped table-bordered nowrap" style="width: 100% !important;">
                                    <thead>
                                        <tr>
                                            <th colspan="8" style="text-align: center;text-transform: capitalize;font-size:20px;"><?php echo e($task); ?><?php if($session_data['group'] == 'AG'): ?><?php echo e('-'.$agency_name[0]->agency_name); ?><?php endif; ?></th>
                                            
                                            <th></th>
                                            <?php if($session_data['group'] == 'FM'): ?>
                                            <th colspan="5"></th>
                                            <?php endif; ?>
                                            <th></th>
                                        </tr>
                                    ...
                                    <?php if( $session_data["group"] != 'FM' ): ?>
                                        <tr style="height: 40px;text-align: center;">
                                            ...
                                            <td><?php echo e(!empty($total_task[0]->total) ? $total_task[0]->total : '0'); ?></td>
                                            <td><?php echo e(!empty($total_done[0]->total) ? $total_done[0]->total : '0'); ?></td>
                                            <td><?php echo e(!empty($total_pending) ? $total_pending : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task[0]->ManagerReject) ? $dm_task[0]->ManagerReject : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task[0]->ManagerVerified) ? $dm_task[0]->ManagerVerified : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task[0]->QualityReject) ? $dm_task[0]->QualityReject : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task[0]->QualityVerified) ? $dm_task[0]->QualityVerified : '0'); ?></td>
                                            <td><?php echo e(!empty($locked[0]->total_locked) ? $locked[0]->total_locked : '0'); ?></td>
                                    ...
                                    <?php else: ?>
                                        <tr style="height: 40px;text-align: center;">
                                            <td width="100px">Analytics</td>
                                            <td><?php echo e(!empty($family_total_task) ? $family_total_task : 0); ?></td>

                                            <td><?php echo e(!empty($total_done_p1[0]->total) ? $total_done_p1[0]->total : 0); ?></td>
                                            <td><?php echo e(!empty($total_done_p2[0]->total) ? $total_done_p2[0]->total : 0); ?></td>
                                            <td><?php echo e(!empty($total_pending_p1) ?  $total_pending_p1 : 0); ?></td>
                                            <td><?php echo e(!empty($total_pending_p2) ? $total_pending_p2 : 0); ?></td>
                                            <td><?php echo e(!empty($dm_task_p1[0]->ManagerReject) ? $dm_task_p1[0]->ManagerReject : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_p1[0]->ManagerVerified) ? $dm_task_p1[0]->ManagerVerified : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_p1[0]->QualityReject) ? $dm_task_p1[0]->QualityReject : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_p1[0]->QualityVerified) ? $dm_task_p1[0]->QualityVerified : '0'); ?></td>
                                            <td ><?php echo e(!empty($family_loan[0]->family_locked) ? $family_loan[0]->family_locked : '0'); ?></td>
                                            <td ><?php echo e($Family_a[0]->green_analysis + $Family_a[0]->yellow_analysis); ?></td>
                                            <td ><?php echo e(!empty($family_loan[0]->family_verified) ? $family_loan[0]->family_verified : '0'); ?></td>
                                            <td><?php echo e(!empty($family_loan[0]->family_get_loan) ? $family_loan[0]->family_get_loan : '0'); ?></td>
                                        ...
                                        <tr style="height: 40px;text-align: center;">
                                            <td>Rating </td>
                                            <td><?php echo e(!empty($total_task_r[0]->total) ? $total_task_r[0]->total : '0'); ?></td>
                                            <td><?php echo e(!empty($total_done_r[0]->total_done) ? $total_done_r[0]->total_done : '0'); ?></td>
                                            <td><?php echo e(!empty($total_pending_r) ? $total_pending_r : '0'); ?></td>
                                            <td><?php echo e($dm_task_r[0]->ManagerReject_r ?? '0'); ?></td>
                                            <td><?php echo e($dm_task_r[0]->ManagerVerified_r ?? '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_r[0]->QualityReject_r) ? $dm_task[0]->QualityReject_r : '0'); ?></td>
                                            <td><?php echo e($dm_task_r[0]->QualityVerified_r ?? '0'); ?></td>
                                            <td></td>
                                           <!--  <?php if($session_data['group'] == 'FM'): ?>
                                            <td></td>
                                            <td></td>
                                        ...
                                        <tr style="height: 40px;text-align: center;">
                                            <td>Rating</td>
                                            <td><?php echo e(!empty($total_task_r[0]->total) ? $total_task_r[0]->total : '0'); ?></td>
                                            <td colspan="2"><?php echo e(!empty($total_done_r[0]->total_done) ? $total_done_r[0]->total_done : '0'); ?></td>
                                            <td colspan="2"><?php echo e(!empty($total_pending_r) ? $total_pending_r : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_r[0]->ManagerReject_r) ? $dm_task_r[0]->ManagerReject_r : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_r[0]->ManagerVerified_r) ? $dm_task_r[0]->ManagerVerified_r : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_r[0]->QualityReject_r) ? $dm_task_r[0]->QualityReject_r : '0'); ?></td>
                                            <td><?php echo e(!empty($dm_task_r[0]->QualityVerified_r) ? $dm_task_r[0]->QualityVerified_r : '0'); ?></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
                                            <td></td>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/processStepreport/list.blade.php ENDPATH**/ ?>