...
.agency-dp button.multiselect:focus {
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                ...
                                <form class="container" method="POST" action="<?php echo e(route('users.update', $user->id)); ?>"
                                    autocomplete="off">
                                    <?php echo method_field('PATCH'); ?>
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e(!empty($user->id) ? $user->id : ''); ?>">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control u_type" name="u_type" id="u_type" readonly>
                                                ...
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->roles_slug); ?>" <?php if ($user->u_type == $row->roles_slug) {
                                                        echo 'selected';
                                                    } ?>>
                                                        <?php echo e($row->roles_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        <?php if($family_pending_tasks[0]->family !=0 || $shg_pending_tasks[0]->shg !=0 || $clus_pending_tasks[0]->cluster !=0 || $fed_pending_tasks[0]->federation !=0): ?>
                                            <div class="col-md-6 mb-3" id="div_module_id">
                                                ...
                                                <select class=" form-control" name="agency_id[]" id="agency_id"
                                                    ...
                                                    <?php $__currentLoopData = $agency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($row->agency_id); ?>"
                                                            <?php if(in_array($row->agency_id, explode(',', $user->agency_id))): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                                ...
                                                <span class="red">NOTE: Agency for this user cannot be change as there are pending tasks as metioned below.
                                                    <br>
                                                    Family - <?php echo e($family_pending_tasks[0]->family ?? 0); ?>,
                                                    SHG - <?php echo e($shg_pending_tasks[0]->shg ?? 0); ?>,
                                                    Cluster - <?php echo e($clus_pending_tasks[0]->cluster ?? 0); ?>,
                                                    Federation - <?php echo e($fed_pending_tasks[0]->federation ?? 0); ?>.
                                                </span>
                                            </div>
                                        <?php else: ?>
                                            <div class="col-md-6 mb-3" id="div_module_id">
                                        ...
                                        <div class="col-md-6 mb-3" id="div_module_country1">
                                            ...
                                            <select class="form-control country" id="country" name="country" required>
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->id); ?>" <?php if ($users_mappings[0]->country_id == $row->id) {
                                                        echo 'selected';
                                                    } ?>>
                                                        <?php echo e($row->name); ?>
                                        ...
                                        <div class="col-md-12 form-group" id="div_module_country">
                                            <div class="table-responsive">
                                                <table id="facilitator_table"
                                                    ...
                                                    <tbody>
                                                        <?php if(!empty($users_mappings)): ?>
                                                            <?php $count = 0; ?>
                                                            <?php $__currentLoopData = $users_mappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $users_mapping): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr>
                                                                    
                                                                    <td>
                                                                        <select class="form-control state" id="state"
                                                                            name="state[<?php echo e($count); ?>]">
                                                                            <option value="">--Select--</option>
                                                                    ...
                                                                    <td>
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            name="district[<?php echo e($count); ?>][]"
                                        ...
                                        <div class="col-md-12 mb-3" id="div_agency_dm" style="display:none">
                                            ...
                                            <div class="agency-dp">
                                            <input type="hidden" value="<?php echo e($fac_agency[0]->agency); ?>" name="agency_hide_name">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="name"
                                                value="<?php echo e($user->name); ?>" autocomplete="off" required
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="gender" name="gender" class="form-control gender" required>
                                                <option value="">--Select--</option>
                                                <?php $__currentLoopData = $gender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->gender_short_name); ?>" <?php if ($user->gender_c == $row->id) {
                                                        echo 'selected';
                                                    } ?>>
                                                        <?php echo e($row->gender_name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3" id="admin_country">
                                            ...
                                            <select class="form-control " name="admin_country" id="select_admin_country">
                                                <option value="">--Select--</option>
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->id); ?>"<?php if ($users_mapping->country_id == $row->id) {
                                                        echo 'selected';
                                                    } ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control number"
                                                value="<?php echo e($user->mobile); ?>" autocomplete="off" id="phone"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group show_hide_password">
                                                <input type="password" class="form-control" name="password"
                                                    value="<?php echo e($user->password_show); ?>" autocomplete="off" minlength="8"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group show_hide_password">
                                                <input type="password" class="form-control" name="password_confirmation"
                                                    value="<?php echo e($user->password_show); ?>" autocomplete="off" required>
                                                <div class="input-group-addon"
                                                    style="background-color: #e9ecef;padding: .3rem .75rem !important;">
                                                    <a href="" class="eye_link"><i class="fa fa-eye-slash"
                                                            aria-hidden="true"></i></a>
                            ...
                            <div class="row">
                                <div class="col-md-12 mb-3 text-center">
                                    ...
                                    <a href="<?php echo e(url('users')); ?>" class="btn btn-sm btn-danger">Back</a>
                                </div>
                            </div>
                            </form>
                        </div>
    ...
    <script>
        ...
        function get_partner_list() {
            ...
            var parent_id = "<?php echo e(!empty($user->parent_id) ? $user->parent_id : ''); ?>";
            if (u_type == 'QA' || u_type == 'M' || u_type == 'A') {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data != '') {
                            $('#parent_id').html(data);
                            $('#parent_id').val("<?php echo e($user->parent_id); ?>");
                        }
                    }
                });
            } else {
        ...
        $('body').on('change', '.country', function(e) {
            ...
            if ("<?php echo e($users_mappings[0]->country_id); ?>" == country) {
                $.ajax({
                    type: 'GET',
                    url: "/get_state",
        ...
        var location_counter = "<?php echo e(!empty($users_mappings) ? count($users_mappings) : '1'); ?>";
        ...
        $(document).ready(function() {
            ...
            $('#agency_dm option').each(function() {
                var valuesToDisable = '<?php echo e($fac_agency[0]->agency); ?>';
            ...
            <?php $__currentLoopData = $users_mappings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                district_arr_f.push([]);
                district_arr_f["<?php echo e($key); ?>"].push([<?php foreach (explode(',', $value->district_id) as $value1) {
                    echo $value1 . ',';
                } ?>]);
                state_arr_f.push('<?php echo e($value->state_id); ?>');
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            //console.log(district_arr_f);

            <?php if($user->u_type == 'F'): ?>
                $('#div_module_id').show();
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/users/edit.blade.php ENDPATH**/ ?>