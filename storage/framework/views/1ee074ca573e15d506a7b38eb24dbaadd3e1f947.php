                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        <fieldset>
                                            ...
                                            <form class="" method="POST" action="<?php echo e(route('federation.store')); ?>"
                                                autocomplete="off">
                                                <?php echo csrf_field(); ?>
                                                <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/federation/add.blade.php ENDPATH**/ ?>