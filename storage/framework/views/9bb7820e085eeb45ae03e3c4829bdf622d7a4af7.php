...
<h5 style="font-family: Arial, Helvetica, sans-serif;position:relative;left:71%;top:-50px;font-size:20px;">Generate On- <?php
    ...
    <div class="page-header-title">
        <div class="d-inline">
            <h2 style="font-family: Arial, Helvetica, sans-serif;text-align:center;font-size:30px;">DART/VESTINVILLAGES - CONSENT FORM <?php echo e($profile[0]->uin); ?>
    ...
    <table class="table table-bordered-dark table-stripped table1 " cellspacing="0" style="border: 1px black solid;">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->read_and_understand == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                
                <td style="border: 1px black solid;">considered the information and what will be expected of me.  </td>
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->considered_the_info == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                
                <td style="border: 1px black solid;">had the opportunity to ask questions which have been answered to my satisfaction</td>
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->had_the_opportunity == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                
                <td style="border: 1px black solid;">decided I would like to take part in this individual interview with my family members</td>
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->decided == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->understood_the_potential == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_participation == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                <td></td>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->If_there == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_personal == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                <td style="border: 1px black solid;">my data will be stored securely in DART/VestinVillages servers. 
                    </td>
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_data == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_information == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->village_invest == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->i_will_not == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->i_am_aware == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_personal_and_business == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                
                <td style="border: 1px black solid;">my personal data maybe used as marketing material to attract lenders. 
                    </td>
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->my_personal_data == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
            <tr>
                <td width="50px" style="border: 1px black solid;" ></td>
                ...
                <td width="50px"style="border: 1px black solid;"><?php if($concent[0]->i_understand_that == 1): ?><span class="checkmark"></span> <?php endif; ?></td>
            </tr>
        </tbody>
    </table>
    <br>
    ...
    <table class="table   table1 " cellspacing="0" style="border: white;">
        ...
        <tbody>
            <tr>
                <td width="20%" style="border-bottom: 1px black solid;height:20px;"><?php echo e($concent[0]->name_of_participant); ?></td>
                <td width="20%" ></td>
                <td width="20%" style="border-bottom: 1px black solid;"><?php echo e(change_date_month_name_char(str_replace('/','-',$concent[0]->participant_date))); ?></td>
                <td width="20%"></td>
                <td width="20%" style="border-bottom: 1px black solid;"><img src="<?php echo e(url('/')); ?>/signature/fac_<?php echo e($mst_id); ?>.png" height="30" width="100"></td>
            </tr>
            <tr>
            ...
            <tr>
                <td width="20%" style="border-bottom: 1px black solid;height:20px;"><?php echo e($concent[0]->name_of_facilitator); ?></td>
                <td width="20%" ></td>
                <td width="20%" style="border-bottom: 1px black solid;"><?php echo e(change_date_month_name_char(str_replace('/','-',$concent[0]->facilitator_date))); ?></td>
                <td width="20%"></td>
                
                <td width="20%" style="border-bottom: 1px black solid;"><img src="<?php echo e(url('/')); ?>/signature/par_<?php echo e($mst_id); ?>.png" height="30" width="100"></th></td>
            </tr>
            <tr>
...
</html><?php /**PATH D:\xampp\htdocs\village\resources\views/pdf/familyConsentPdf.blade.php ENDPATH**/ ?>