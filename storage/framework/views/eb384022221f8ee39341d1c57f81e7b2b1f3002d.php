                        ...
                        <div class="login__form">
                            <?php if(session('success')): ?>
                                <div class="alert alert-success" role="alert"
                                    style="
                                font-size: 19px;"> <?php echo e(session('success')); ?>
                            ...
                            <?php if(session('error')): ?>
                                <div class="alert alert-danger" role="alert"
                                    style="
                                font-size: 19px;"> <?php echo e(session('error')); ?>
                            ...
                            <form method="POST" action="<?php echo e(route('otp.getlogin')); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <?php $__errorArgs = ['otp'];
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="login__row">
                                    ...
                                    <input class="login__input pass" placeholder="otp" autocomplete="off" name="otp"
                                        id="otp" type="otp" required>
                                </div>
                                ...
                                <form method="POST" action="<?php echo e(route('regenerate')); ?>">
...
<?php /**PATH D:\xampp\htdocs\village\resources\views/auth/otp-login.blade.php ENDPATH**/ ?>