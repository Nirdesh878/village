    ...
    <div class="page-header">
        <div class="row align-items-end">
            ...
            <div class="export_icon_css" style="margin-top: -32px;">
                <a href="<?php echo e(url('FederationExport')); ?>" id="export">
            ...
            <div class="export_pdf_css" style="margin-top: -32px;  !important;">
                <a href="<?php echo e(URL::to('/federationPDF')); ?>">
            ...
            <div class="col-lg-4 text-right">
                    <a href="<?php echo e(url('federation/create')); ?>" class="btn cur-p btn-sm btn-success">Create Federation
                    </a>
            </div>
        </div>
    </div>
...
<script>
    $(function(){
        ...
        "responsive"  :false,
        "ajax": {
        "url": '<?php echo e(route('federation.index')); ?>',
        "type": "GET",
        "dataType": "json",
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if(result)
                {
                    ...
                    var url = '<?php echo e(route("federation.destroy", ":id")); ?>';
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/federation/list.blade.php ENDPATH**/ ?>