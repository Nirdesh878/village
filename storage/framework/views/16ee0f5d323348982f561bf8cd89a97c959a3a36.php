                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                ...
                                <form class="container" method="POST" action="<?php echo e(route('users.store')); ?>"
                                    autocomplete="off">
                                    <?php echo csrf_field(); ?>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control u_type" name="u_type" id="u_type" required>
                                                ...
                                                <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->roles_slug); ?>"
                                                        <?php if(old('u_type') == $row->roles_slug): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                            ...
                                            <select class="js-example-basic-multiple form-control" name="agency_id[]"
                                                ...
                                                <?php $__currentLoopData = $agency; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->agency_id); ?>"
                                                        <?php if(in_array($row->agency_id, $select_arr)): ?> ) <?php echo e('selected'); ?> <?php endif; ?>>
                                            ...
                                            <select class="form-control country" id="country" name="country">
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->id); ?>"
                                                        <?php if(old('country') == $row->id): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select id="gender" name="gender" class="form-control gender" required>
                                                ...
                                                <?php $__currentLoopData = $gender; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->gender_short_name); ?>"
                                                        <?php if(old('gender') == $row->gender_short_name): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                        ...
                                        <div class="col-md-6 mb-3" id="admin_country">
                                            ...
                                            <select class="form-control " name="admin_country" id="select_admin_country">
                                                ...
                                                <?php $__currentLoopData = $countries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($row->id); ?>"
                                                        <?php if(old('admin_country') == $row->id): ?> <?php echo e('selected'); ?> <?php endif; ?>>
                                                        <?php echo e($row->name); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </select>
                                        </div>
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <span style="width: 15%;float: left;margin-top:26px;">
                                                ...
                                                <input class="form-control " type="text" value="<?php echo e(old('tel')); ?>"
                                                    id="tel" name="tel" readonly>
                                            </span>
                                            <input type="text" class="form-control number"
                                                value="<?php echo e(old('mobile')); ?>" autocomplete="off" id="phone"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control status_inex" name="status_inex" id="status_inex"
                                                ...
                                                <option value="internal"
                                                    <?php if(old('status_inex') == 'internal'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Internal
                                                </option>
                                                <option value="external"
                                                    <?php if(old('status_inex') == 'external'): ?> <?php echo e('selected'); ?> <?php endif; ?>>External
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3" id="delete_per">
                                            ...
                                            <select class="form-control delete_inex" name="delete_inex" id="delete_inex"
                                                ...
                                                <option value="">--Select--</option>
                                                <option value="A"
                                                    <?php if(old('delete_inex') == 'A'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Allowed
                                                </option>
                                                <option value="D"
                                                    <?php if(old('delete_inex') == 'D'): ?> <?php echo e('selected'); ?> <?php endif; ?> selected>Denied
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control status" name="status" id="status" required>
                                                <option value="">--Select--</option>
                                                <option value="A"
                                                    <?php if(old('status') == 'A'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Active
                                                </option>
                                                <option value="I"
                                                    <?php if(old('status') == 'I'): ?> <?php echo e('selected'); ?> <?php endif; ?>>Inactive
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group show_hide_password">
                                                <input type="password" class="form-control" name="password"
                                                    value="<?php echo e(old('password')); ?>" autocomplete="off" minlength="8"
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <div class="input-group show_hide_password">
                                                <input type="password" class="form-control" name="password_confirmation"
                                                    value="<?php echo e(old('password_confirmation')); ?>" autocomplete="off"
                                                    required>
                                                <div class="input-group-addon"
                                                    style="background-color: #e9ecef;padding: .3rem .75rem !important;">
                                                    <a href="" class="eye_link"><i class="fa fa-eye-slash"
            ...
            if ( u_type == 'QA' || u_type == 'M' || u_type == 'A') {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data != '') {
                            $('#parent_id').html(data);
                            $('#parent_id').val("<?php echo e(old('parent_id')); ?>");
                        }
                    }
                });
            }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\village\resources\views/users/add.blade.php ENDPATH**/ ?>