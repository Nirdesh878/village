    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">SHG</li>
                    </ul>
                </div>
                ...
                <div class="export_icon_css" style="margin-top: -32px;">
                    <a href="{{ url('SHGExport') }}" id="export">
            ...
            <div class="col-lg-4 text-right">
                    <a href="{{ url('shg/create') }}" class="btn cur-p btn-sm btn-success">Create SHG
                    </a>
            </div>
        </div>
    </div>
        ...
        <div class="row pb-4">
            ...
            <div class="col-sm">
                <div class="w-box1 s-box">
                    <div class="d-flex">
                        <div class="count"><h4>Onboarded Family</h4><h3>{{getCount('family_mst')}}</h3></div>
            ...
            <div class="col-sm">
                <div class="w-box2 s-box">
                    <div class="d-flex">
                        <div class="count"><h4>Onboarded SHG</h4><h3>{{getCount('shg_mst')}}</h3></div>
            ...
            <div class="col-sm">
                <div class="w-box3 s-box">
                    <div class="d-flex">
                        <div class="count"><h4>Onboarded Cluster</h4><h3>{{getCount('cluster_mst')}}</h3></div>
            ...
            <div class="col-sm">
                <div class="w-box4 s-box">
                    <div class="d-flex">
                        <div class="count"><h4>Onboarded Federation</h4><h3>{{getCount('federation_mst')}}</h3></div>
...
<script>
    ...
    function fn_delete(id)
    {
        bootbox.confirm({
            title: "",
            message: "Are you sure, you want to delete this SHG?",
