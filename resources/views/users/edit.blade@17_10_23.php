                                    ...
                                    <div class="row">
                                        ...
                                        @if (count($pending_tasks) > 0)
                                            <div class="col-md-6 mb-3" id="div_module_id">
                                                ...
                                                <span class="red">NOTE: User can't change the agency untill task is
                                                    pending.</span>
                                            </div>
                                        @else
                                            <div class="col-md-6 mb-3" id="div_module_id">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            @if ($user->u_type == 'F')
                ...
                $('#admin_country,#div_agency_dm').hide();
                $('#admin_country,#div_agency_dm').attr('required', false);
            ...
            @elseif ($user->u_type == 'QA')
                ...
                $('#div_module_id,#div_agency_dm').attr('required', false);
            ...
            @elseif ($user->u_type == 'A')
                ...
                $('#div_parent_id').show();
                $('#div_parent_id').attr('required', true);
                $('#div_module_country,#div_agency_dm').hide();
                $('#div_module_country1').hide();
                $('#div_module_id').hide();
                $('#div_module_id,#div_agency_dm').attr('required', false);
                $('#country').attr('required', false);
            ...
            @else
                $('#div_module_id').hide();
                $('#div_module_country').hide();
                $('#div_module_country1,#div_agency_dm').hide();
                $('#div_module_id,#div_agency_dm').attr('required', false);
