...
@endphp
        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="col-lg-4 text-right">
                    <a href="{{ url('users/create') }}" class="btn cur-p btn-sm btn-success">Create Users
                    </a>
                </div>
            </div>
        </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <form class="container" method="GET" action="{{ url('users') }}" id="needs-validation" autocomplete="off">
                                @csrf
                                @php $session_data = Session::get('user_filter_session'); @endphp
                            ...
                            <div class="col-md-2 mb-2" style="position: relative;left:35%;top:-15px;">
                                ...
                                <div class="export_icon_css" style="top: 32%;">
                                    <a href="{{url('export_user')}}" id="export">
    ...
    <script>
        ...
        $(document).ready(function() {
            @php echo !empty($session_data["user_type"]) && $session_data["user_type"]!='' ? "$('#user_type').val('".$session_data["user_type"]."');" : "" @endphp
        });
    </script>
