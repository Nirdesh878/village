            ...
            <div class="col-lg-8">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">SHG Pre-Assignment</li>
                    </ul>
                </div>
                <div style="clear: both"></div>
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>SHG Pre-Assignment</h4>
                    </div>
                </div>
            </div>
            <div class="export_icon_css" style="margin-top: -32px;">
                <a href="{{ url('ShgTasklist') }}" id="export">
    ...
    function submitAction() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.result == 1) {
                    window.location.href = "{{url('shg_task')}}";
                }
            }
        });
