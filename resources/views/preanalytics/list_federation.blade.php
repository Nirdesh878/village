    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">Federation Pre-Assignment</li>
                    </ul>
                </div>
                <div style="clear: both"></div>
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Federation Pre-Assignment</h4>
                    </div>
                </div>
            ...
            <div class="export_icon_css" style="margin-top: -32px;">
                <a href="{{ url('FederationTasklist') }}" id="export">
            ...
            <div class="export_pdf_css" style="margin-top: -32px;">
                <a href="{{ URL::to('/federationTasklistPdf') }}">
            ...
            <div class="col-sm-12">
                ...
                <div class="card">
                    <div class="card-block">
                        ...
                        <a href="{{ url('/preanalytics_task') }}" ><button class="btn btn-success" type="button"  title="Assign Task" style="width:140px;font-size:18px;">Assign Task </button></a>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select class="form-control form-control-sm" name="TaskAssignment_status" id="TaskAssignment_status">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6" id="remark_txt">
                        <textarea class="form-control form-control-sm" name="TaskAssignment_remark" id="TaskAssignment_remark"></textarea>
                    </div>
                </div>
                <input type="hidden" name="task_id" id="task_id">
                <span style="font-size:12px; color: red;margin-left: 39px;"><i>Note : The task will rejected completely and will not be accepted in the future.</i></span>
                </p>
            </div>
    ...
    function submitAction() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.result == 1) {
                    window.location.href = "{{url('federation_task')}}";
                }
            }
        });
