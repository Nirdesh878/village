...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item">Assign Task (SHG)</li>
                        </ul>
                    </div>
                    <div style="clear: both"></div>
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Assign Task (SHG)</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                <form class="container" method="POST" action="{{ url('store_shg') }}" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">Cluster<span class="red">*</span></label>
                                            <select class="form-control cluster_id" name="cluster_id" id="cluster_id" required>
                                                <option value="">--Select--</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">SHG<span class="red">* (Unassigned SHG)</span></label>
                                    ...
                                    {{-- <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">Quality / District Manager<span class="red">*</span></label>
                                            <select class="form-control quality_id" name="quality_id" id="quality_id" required>
                                                <option value="">--Select--</option>
                                                @foreach($qc_list as $row)
                                                    <option value="{{ $row->id }}">{{ $row->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#agency_id').on('change', get_cluster_list_task);
            //$('#agency_id').on('change', get_facilitator_list);
        });

        function get_cluster_list_task() {
            var obj = $(this);
            var agency_id = obj.val();
            if (agency_id != '') {
                $.ajax({
                    type: 'GET',
                    url: '/get_cluster_list_task',
