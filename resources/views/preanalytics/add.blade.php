        ...
        <div class="page-header">
            <div class="row align-items-end">
                ...
                <div class="export_icon_css" style="margin-top: -32px;">
                    <a href="{{ url('FamilyTasklist') }}" id="export">
                ...
                <div class="export_pdf_css" style="margin-top: -32px;">
                    <a href="{{ URL::to('/familyTasklistPdf') }}">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            ...
                            <a href="{{ url('/preanalytics_task') }}"><button class="btn btn-success" type="button"
        ...
        function submitAction() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (data.result == 1) {
                        window.location.href = "{{ url('preanalytics/create') }}";
                    }
                }
            });
