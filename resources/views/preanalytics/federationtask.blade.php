...
@section('content')
                ...
                <div class="col-lg-8">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item">Assign Task (Federation)</li>
                        </ul>
                    </div>
                    <div style="clear: both"></div>
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Assign Task (Federation)</h4>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                <form class="container" method="POST" action="{{ url('store_federation') }}" autocomplete="off">
                                    @csrf
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">Federation<span class="red">* (Unassigned Federation)</span></label>
    ...
    <script>
        $(document).ready(function () {
            $('#agency_id').on('change', get_federation_list_task_federation);
