    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-breadcrumb">
                    <ul class="breadcrumb-title">
                        ...
                        <li class="breadcrumb-item">Cluster-Pre Assignment</li>
                    </ul>
                </div>
                <div style="clear: both"></div>
                <div class="page-header-title">
                    <div class="d-inline">
                        <h4>Cluster-Pre Assignment</h4>
                    </div>
                </div>
            </div>
            <div class="export_icon_css" style="margin-top: -32px;">
                <a href="{{ url('ClusterTasklist') }}" id="export">
            ...
            <div class="export_pdf_css" style="margin-top: -32px;">
                <a href="{{ URL::to('/clusterTasklistPdf') }}">
    ...
    function submitAction() {
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (data.result == 1) {
                    window.location.href = "{{url('cluster_task')}}";
                }
            }
        });
