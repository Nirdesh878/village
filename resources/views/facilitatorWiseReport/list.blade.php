    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                @php $session_data = Session::get('facilitator_filter_session'); @endphp
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <form class="container" method="GET" action="{{ url('FacilitatorWiseReport') }}" id="needs-validation" autocomplete="off">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-3">
                                        <div class="export_icon_css" style="top: 32%">
                                            <a href="{{ url('export_facilitator') }}" id="export">
                                        ...
                                        <div class="export_pdf_css" style="top: 32%;right: 12% !important;">
                                            <a href="{{ URL::to('/facilitatorWiseReportPdf') }}">
                    ...
                    <div class=" modal-header-full-width   modal-header text-center">
                        ...
                        <div class="col-md-7 mb-4" ">
                            ...
                            <div class="export_pdf_css" style="top:32%;">
                                <a href="{{ URL::to('/taskassignedReportPdf') }}" id="abc">
                                    <img src="{{ asset('assets\images\pdf.png') }}" data-toggle="tooltip" title="PDF Download" alt="PDF Download" title="PDF Download" class="lzy lazyload--done" style="height: 35px;">
                                </a>
                            </div>
                        </div>
       ...
       return dl ?
        ...
        $(function() {
            var table = $('#simpletable').DataTable({
                ...
                "responsive": false,
                "ajax": {
                    "url": '{{ route("FacilitatorWiseReport.index") }}',
                    "type": "GET",
                    "dataType": "json",
                    "data": function(data) {
        ...
        $(document).ready(function() {
            ...
            "');": ""
            @endphp
            {{-- $('#facilitator').val('{{ $session_data['facilitator'] }}'); --}}
        ...
        function getTaskDetails(userID,state_id) {
            ...
            if (userID != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#taskTable').html(data);
                        $('#abc').attr('href', "{{ URL::to('/taskassignedReportPdf') }}?" + 'userID=' + userID +'&'+ 'state_id=' + state_id);
                    }
                });
            }
        }
