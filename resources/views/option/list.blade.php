    ...
    <div class="page-header">
        <div class="row align-items-end">
            ...
            <div class="col-lg-4 text-right">
                    <a href="{{ url('option/create') }}" class="btn cur-p btn-sm btn-success">Create Option
                    </a>
            </div>
        </div>
    </div>
...
<script>
    ...
    function fn_delete(catid,subid,qid)
    {
        var id=[catid,subid,qid];
        bootbox.confirm({
            title: "",
            ...
            callback: function (result) {
                if(result)
                {
                    ...
                    var url = '{{ route("option.destroy", ":id") }}';
