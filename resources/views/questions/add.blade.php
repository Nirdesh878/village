                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                <form class="container" method="POST" action="{{ route('questions.store') }}" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="mst_ques_name"  value="{{ old('mst_ques_name') }}" autocomplete="off" required>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">Description<span class="red">*</span></label>
                                            <input type="text" class="form-control" name="mst_ques_description"  value="{{ old('mst_ques_description') }}" autocomplete="off" required>
                                        </div>
                                          </div>
                                    <div class="row">
                                         <div class="col-md-6 mb-3">
