        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-lg-8">
                    ...
                    @php $session_data = Session::get('fed_filter_session'); @endphp
                    ...
                    <div class="page-header-title">
                        ...
                        <div class="pull-right">
                            <div class="export_icon_css">
                                <a href="{{ url('export_fedreport') }}" id="export">
                            ...
                            <div class="export_pdf_css">
                                <a href="{{ URL::to('/products/create-pdf') }}"><img
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form class="container" method="GET" action="{{ url('fedreports') }}"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                @if (!empty($session_data['group']) && empty($session_data['federation']))
                                                    ...
                                                    @php echo !empty($session_data["group"]) && $session_data["group"]=='CL' ? "<th width='15%'>Cluster Name</th>" : (!empty($session_data["group"]) && $session_data["group"]=='SH' ? "<th width='15%'>SHG Name</th><th width='15%'>Cluster Name</th>" : "") @endphp
                                                    @php echo !empty($session_data["group"]) && $session_data["group"]=='FM' ? "<th width='15%'>SHG Member Name</th><th width='15%'>SHG Name</th><th width='15%'>Cluster Name</th>" : "" @endphp
                                                ...
                                                @elseif(!empty($session_data['federation']) &&
