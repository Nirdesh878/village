...
<head>
    ...
    <title>{{ config('app.APP_NAME', 'DART') }}</title>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('bower_components\owl.carousel\css\owl.theme.default.css') }}">

    <link rel="stylesheet" type="text/css"
        href="{{ asset('bower_components\ekko-lightbox\css\ekko-lightbox.css') }}">
...
<body>
                ...
                <div class="navbar-wrapper">
                    ...
                    <div class="navbar-logo" style="width: 220px;">
                        ...
                        <a href="{{ url('home') }}">
                            ...
                            <img src="{{ asset('assets\images\Dart-logo2.png') }}" style="height: 40px">
                        </a>
                    ...
                    <div class="navbar-container container-fluid">
                        ...
                        <div class="nav-left">
                            {{-- @if ($user->partner_id == 5)
                            <h4 style="float: left; padding: 10px 0px; margin: 0px;color:black;">Dashboard for Village Analytics </h4>
                        @else<h4 style="float: left; padding: 10px 0px; margin: 0px;color:black;">Management Information System For Village Analytics </h4>
                        @endif --}}
                            ...
                            <li class="user-profile header-notification">
                                <div class="dropdown-primary dropdown">
                                    ...
                                    <ul class="show-notification profile-notification dropdown-menu"
                                        ...
                                        <li>
                                            <div class="out">
                                                <a class="dropdown-item" class="out"  href="{{ route('logout') }}"
                    ...
                    <nav class="pcoded-navbar">
                        <div class="pcoded-inner-navbar main-menu pt-2" style="width: 220px;">
                            ...
                            <ul class="pcoded-item pcoded-left-item">
                                ...
                                @elseif($user->u_type == 'CEO' || $user->u_type == 'A')
                                    <li class=" ">
                                        <a href="{{ url('home') }}">
                                            <span class="pcoded-micon"><i
                                                    class="feather icon-home"></i><b>A</b></span>
                                    ...
                                    @if ($user->u_type == 'CEO')
                                        ...
                                        <li class="pcoded-hasmenu ">
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="@if (Request::is('module') || Request::is('module/*')) active @endif">
                                                    <a href="{{ url('module') }}">
                                                        <span class="pcoded-micon"><i
                                                ...
                                                <li class="@if (Request::is('section') || Request::is('section/*')) active @endif">
                                                    <a href="{{ url('section') }}">
                                                        <span class="pcoded-micon"><i
                                                                class="feather feather icon-award"></i><b>A</b></span>
                                                ...
                                                <li class="@if (Request::is('subsection') || Request::is('subsection/*')) active @endif">
                                                    <a href="{{ url('subsection') }}">
                                                        <span class="pcoded-micon"><i
                                                                class="feather feather icon-award"></i><b>A</b></span>
                                                ...
                                                <li class="@if (Request::is('applabel') || Request::is('applabel/*')) active @endif">
                                                    <a href="{{ url('applabel') }}">
                                                        <span class="pcoded-micon"><i
                                                                class="feather feather icon-award"></i><b>A</b></span>
                                        ...
                                        <li class="pcoded-hasmenu @if (Request::is('category') || Request::is('category/*') || Request::is('subcategory') || Request::is('subcategory/*') || Request::is('questions') || Request::is('questions/*') || Request::is('option') || Request::is('option/*')) pcoded-trigger @endif">
                                            <a href="javascript:void(0)">
                                                <span class="pcoded-micon"><i
                                                        class="feather icon-check-circle"></i><b>A</b></span>
                                            ...
                                            <ul class="pcoded-submenu">
                                                <li class="@if (Request::is('category') || Request::is('category/*')) active @endif">
                                                    <a href="{{ url('category') }}">
                                                        <span class="pcoded-micon"><i
                                                                class="feather feather icon-award"></i><b>A</b></span>
                                                ...
                                                <li class="@if (Request::is('subcategory') || Request::is('subcategory/*')) active @endif">
                                                ...
                                                <li class="@if (Request::is('questions') || Request::is('questions/*')) active @endif">
                                                ...
                                                <li class="@if (Request::is('option') || Request::is('option/*')) active @endif">
                                                    <a href="{{ url('option') }}">
                                                        <span class="pcoded-micon"><i
                                                                class="feather feather icon-award"></i><b>A</b></span>
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if (Request::is('mapDatatableFamily') || Request::is('mapDatatableFamily/*')) active @endif">
                                                <a href="{{ url('mapDatatableFamily') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Family map</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('mapDatatableSHG') || Request::is('mapDatatableSHG/*')) active @endif">
                                                <a href="{{ url('mapDatatableSHG') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">SHG map</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('mapDatatableCluster') || Request::is('mapDatatableCluster/*')) active @endif">
                                                <a href="{{ url('mapDatatableCluster') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                            ...
                                            <li class="@if (Request::is('mapDatatable') || Request::is('mapDatatable/*')) active @endif">
                                                <a href="{{ url('mapDatatable') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                    ...
                                    <li class="pcoded-hasmenu @if (Request::is('fedreports') || Request::is('fedreports/*') || Request::is('clusterreport')) pcoded-trigger @endif">
                                        <a href="javascript:void(0)">
                                            <span class="pcoded-micon"><i
                                                    class="feather icon-check-circle"></i><b>A</b></span>
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if (Request::is('fedreports') || Request::is('fedreports/*')) active @endif">
                                                <a href="{{ url('fedreports') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                            ...
                                            <li class="@if (Request::is('CummulativeReport') || Request::is('CummulativeReport/*')) active @endif">
                                                <a href="{{ url('CummulativeReport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Cummulative Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('FamilyWealthReport') || Request::is('FamilyWealthReport/*')) active @endif">
                                                <a href="{{ url('FamilyWealthReport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                            ...
                                            <li class="@if (Request::is('FacilitatorWiseReport') || Request::is('FacilitatorWiseReport/*')) active @endif">
                                                <a href="{{ url('FacilitatorWiseReport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Facilitator Wise Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('creditreport') || Request::is('CreditReport/*')) active @endif">
                                                <a href="{{ url('creditreport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Credit Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('creditloanreport') || Request::is('creditloanreport/*')) active @endif">
                                                <a href="{{ url('creditloanreport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Credit Loan Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('processStepreport') || Request::is('processStepreport/*')) active @endif">
                                                <a href="{{ url('processStepreport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Process Step Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('ManagerWiseReport') || Request::is('ManagerWiseReport/*')) active @endif">
                                                <a href="{{ url('ManagerWiseReport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Manager Wise Report</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('QualityWiseReport') || Request::is('QualityWiseReport/*')) active @endif">
                                                <a href="{{ url('QualityWiseReport') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                    ...
                                    <li class="pcoded-hasmenu ">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class="@if (Request::is('family_export') || Request::is('family_export/*')) active @endif">
                                                <a href="{{ url('family_export') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Family Export</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('shg_export') || Request::is('shg_export/*')) active @endif">
                                                <a href="{{ url('shg_export') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">SHG Export</span>
                                                </a>
                                            </li>
                                            <li class="@if (Request::is('cluster_export') || Request::is('cluster_export/*')) active @endif">
                                                <a href="{{ url('cluster_export') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
                                                    <span class="pcoded-mtext">Cluster Export</span>
                                                </a>
                                             </li>
                                            <li class="@if (Request::is('federation_export') || Request::is('federation_export/*')) active @endif">
                                                <a href="{{ url('federation_export') }}">
                                                    <span class="pcoded-micon"><i
                                                            class="feather feather icon-award"></i><b>A</b></span>
    ...
    <!-- light-box js -->
    <script type="text/javascript" src="{{ asset('bower_components\ekko-lightbox\js\ekko-lightbox.js') }}"></script>
    <script type="text/javascript" src="{{ asset('bower_components\lightbox2\js\lightbox.js') }}"></script>
    ...
    <script type="text/javascript" src="{{ asset('assets\js\vartical-layout.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets\js\jquery.mCustomScrollbar.concat.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets\js\script.js') }}"></script>
    <script type="text/javascript" src="{{ asset('assets\js\export_table.js') }}"></script>
    ...
    @if (Request::is('federation/create') || Request::is('cluster/create'))
        <script>
            $(function() {
