                                        ...
                                        <div class="w-box">
                                            <div class="w-heading d-flex">
                                                ...
                                                <div class="ml-auto">
                                                    ...
                                                    <a href="{{ URL::to('/cummulative-report-pdf') }}"><img
                                            ...
                                            <table style="display:none;font-weight:bold;">
                                                <thead>
                                                    <tr >
                                                        <td>Country</td>
                                                        <td>{{!empty($country_name[0]->name) ? $country_name[0]->name : 'India' }}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>State</td>
                                                        <td>{{ !empty($state_name[0]->name) ? $state_name[0]->name : '-'}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>District</td>
                                                        <td>{{!empty($district_name[0]->name) ? $district_name[0]->name : '-'}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>Agency</td>
                                                        <td>{{!empty($agency) ? $agency : '-'}}</td>
                                                    </tr>
                                                    <tr>
                                                        <td>From</td>
                                                        <td>{{!empty($from) ? change_date_month_name_char(str_replace('/','-',$from)) : '-'}}</td>
                                                    </tr> 
                                                    <tr>   
                                                        <td>To</td>
                                                        <td>{{!empty($to) ? change_date_month_name_char(str_replace('/','-',$to)) : '-'}}</td>
                                                    </tr>
                                ...
                                <div class="card-block">
                                    <div class="w-box">
                                        ...
                                        <form class="container" autocomplete="off" method="GET"
                                            action="{{ url('CummulativeReport') }}" id="needs-validation">
                                            @csrf
                                            @php
    ...
    <script>
       ...
       return dl ?
            ...
            if (query != '') {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        @php echo !empty($session_data["agency"]) && $session_data["agency"]>0 ? "$('#agency').val('".$session_data["agency"]."');" : "" @endphp
        ...
        $(document).ready(function() {
            ...
            @php echo !empty($session_data["agency"])  ? "$('#agency').val('".$session_data["agency"]."');" : "" @endphp
            {{-- $('#agency').val('{{ $session_data['agency'] }}'); --}}
