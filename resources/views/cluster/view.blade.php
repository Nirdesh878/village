                                            ...
                                            <div class="row alldetail">
                                                ...
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ $governance[0]->date_last_election != '' ? Change_date_month_name_char(str_replace('/', '-', $governance[0]->date_last_election)) : 'N/A' }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        <div class="col-6"><strong>Last 2 elections conducted as
                                                                ...
                                                                norms</strong></div>
                                                        <div class="col-6">
                                                            {{ $governance[0]->last_two_election_conducted != '' ? $governance[0]->last_two_election_conducted : 'N/A' }}
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row alldetail">
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ checkna($governance[0]->minute_book_to_record_minute) }}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                @if ($governance[0]->social_audit_committee == 'Yes')
                                                    <div class="col-md-6 table-padd">
                                                        <div class="row detail">
                                                            ...
                                                            <div class="col-6">
                                                                {{ $governance[0]->sac_created != '' ? Change_date_month_name_char(str_replace('/', '-', $governance[0]->sac_created)) : 'N/A' }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endif
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    ...
                                                    <th>Committees</th>
                                                    <th> {{ $governance[0]->cluster_sub_committees != '' ? $governance[0]->cluster_sub_committees : 'N/A' }}
                                                    </th>
                                                </tr>
                                            </thead>
                                            ...
                                            <div class="row alldetail">
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ $governance[0]->total_shgs_formed != '' ? $governance[0]->total_shgs_formed : 0 }}
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ $governance[0]->shgs_defunct != '' ? $governance[0]->shgs_defunct : 0 }}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        <div class="col-6"><strong>Defunct SHGs (%)</strong></div>
                                                            <div class="col-6">
                                                                {{ $governance[0]->defunct_shgs_par != '' ? $governance[0]->defunct_shgs_par : 0 }}%
                                                            </div>
                                                </div>
                                                <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Date of last
                                                            update</strong></div>
                                                    <div class="col-6">
                                                        {{ $inclusion[0]->last_update != '' ? Change_date_month_name_char(str_replace('/', '-', $inclusion[0]->last_update)) : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        @endif
                            ...
                            <div class="family-box mt-3">
                                ...
                                <table class="table mytable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>Total</td>
                                            <td>{{ (int) $inclusion[0]->visual_poorest_category + (int) $inclusion[0]->visual_poor_category + (int) $inclusion[0]->visual_medium_category + (int) $inclusion[0]->visual_rich_category }}
                                            </td>
                                    ...
                                    <div class="row alldetail">
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                ...
                                                <div class="col-6">
                                                    {{ $efficiency[0]->cluster_prepared != '' ? $efficiency[0]->cluster_prepared : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Date of last plan approved
                                                            ...
                                                            Cluster</strong></div>
                                                    <div class="col-6">
                                                        {{ $efficiency[0]->date_approved != '' ? Change_date_month_name_char(str_replace('/', '-', $efficiency[0]->date_approved)) : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                    ...
                                    <div class="row alldetail">
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                ...
                                                <div class="col-6">
                                                    {{ $efficiency[0]->time_taken_to_approve_loan != '' ? $efficiency[0]->time_taken_to_approve_loan : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                <div class="col-6"><strong>Average Monthly loans during
                                                        ...
                                                        months</strong></div>
                                                <div class="col-6">
                                                    {{ $efficiency[0]->loans_approved != '' ? $efficiency[0]->loans_approved : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 table-padd">
                                        ...
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                <div class="col-6"><strong>Type (declining or
                                                        flat)</strong></div>
                                                <div class="col-6">
                                                    {{ $creditrecovery[0]->interest_type != '' ? $creditrecovery[0]->interest_type : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                ...
                                                <div class="col-6">
                                                    {{ $creditrecovery[0]->interest_rate != '' ? $creditrecovery[0]->interest_rate : 'N/A' }}
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <table class="table mytable">
                                    <thead class="back-color">
                                        <tr>
                                            ...
                                            <th> {{ $saving[0]->compulsory_savings != '' ? $saving[0]->compulsory_savings : 'N/A' }}
                                            </th>
                                        </tr>
                                    </thead>
                                ...
                                <table class="table mytable">
                                    <thead class="back-color">
                                        <tr>
                                            ...
                                            <th> {{ $saving[0]->voluntary_savings != '' ? $saving[0]->voluntary_savings : 'N/A' }}
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $saving[0]->date_voluntary_saving != '' ? Change_date_month_name_char(str_replace('/', '-', $saving[0]->date_voluntary_saving)) : 'N/A' }}
                                                </td>
                                ...
                                <table class="table mytable">
                                    <thead class="back-color">
                                        <tr>
                                            ...
                                            <th>{{ $saving[0]->loan_security_fund != '' ? $saving[0]->loan_security_fund : 'N/A' }}
                                            </th>
                                        </tr>
                                    </thead>
                                    ...
                                    <table class="table mytable">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $saving[0]->date_established != '' ? Change_date_month_name_char(str_replace('/', '-', $saving[0]->date_established)) : 'N/A' }}
                                                </td>
                                            </tr>
                                            <tr>
                                ...
                                <table class="table mytable table-responsive">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>{{ !empty($analysis_data['poor_current_leadership']) ? $analysis_data['poor_current_leadership'] : 0 }}
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>5</td>
                                            <td>{{ !empty($analysis_data['time_taken_to_approve_loan']) ? $analysis_data['time_taken_to_approve_loan'] : 0 }}
                                            </td>
                                            <td>
                                                <div class='status_analysis {{ $analysis_data['color_11'] }} '>
                                                </div>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class='status_analysis {{ $analysis_data['color111'] }}'></div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td>17</td>
                                ...
                                <div class="card-box">
                                    <table class="table table-bordered mytable" colspan="2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Date</th>
                                                <td>{{ change_date_month_name_char(str_replace('/', '-', $cluster->created_at)) }}
                                                </td>
                                    ...
                                    <table class="table table-bordered mytable" colspan="2">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td style="background-color: yellow;width:50px;">
                                                    @if (round($score1) >= 75 && round($score1) <= 89)
                                                        <i class="c-black-500 ti-check"
                                                            style="font-size:25px;font-weight:bold;"></i>
                                                    @endif
                                                </td>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($remarks as $res)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $status }}</td>
                                                    <td>{{ $qa_status }}</td>
                                                    <td>{{ change_date_month_name_char(str_replace('/', '-', $res->updated_at)) }}
                                                    </td>
