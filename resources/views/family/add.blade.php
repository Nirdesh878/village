                                        ...
                                        <form class="" method="POST" action="{{ route('family.store') }}" autocomplete="off">
                                            ...
                                            <table id="family_table" class="table table-striped table-bordered nowrap">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control fp_contact_no numbers_only" name="fp_contact_no[]" style="min-width: 20%;" title="please enter mobile number"  required>
                                                        </td>
                                                        <td>
                                            ...
                                            <div class="row" id="family_table_b">
                                                <div class="col-md-12 mb-3 text-center">
                                                    <button class="btn btn-sm btn-success mt-4" type="submit">Save</button>
...
<script>
    ...
    $(document).ready(function() {
        $(".fp_contact_no").attr('maxlength', 10);
        $('#table1').hide();
        $('#family_table').hide();
        $('#family_table_b').hide();
    ...
    $('.numbers_only').bind('keyup paste', function() {
    ...
    $('body').on('focusout', '.fp_contact_no', function(e) {
        ...
        //     bootbox.alert('Length should be 10 digit long');
        //     obj.val('');
