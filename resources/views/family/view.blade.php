                ...
                <div class="head-pannel s-box">
                    <div class="d-flex">
                        ...
                        <div class="headerfont">
                            ...
                            <h2>{{ $family_profile[0]->fp_member_name }}</h2>

                            <div class="E-link d-flex">
                                <a href="#">
                                    <p><i class="las la-phone">{{ $family_profile[0]->fp_contact_no }}</i> </p>
                                </a>
                            </div>
                            <p>
                                <span style="padding: 0px 5px;"></span>
                                <span style="padding: 0px 5px;">{{ $family_profile[0]->fp_district }}</span>,
                                <span style="padding: 0px 5px;">{{ $family_profile[0]->fp_state }}</span>,
                                <span style="padding: 0px 5px;">{{ $family_profile[0]->fp_country }}</span>
                            </p>
                        </div>
                        <div class="ml-auto d-flex">
                            <div class="rating-box2 s-box mr-4 {{ $grdcolor }}">
                                <h4>Analytics and Rating</h4>
                                <h3>{{ $grand_total_cy }}</h3>
                            ...
                            <div class="rating-box2 s-box">
                                ...
                                @endphp
                                <h3>{{ $WealthData[0]->common_values ?? 'N/A' }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row mt-3" style="margin-top:30px">
                    <div class="col-3 faily-tab">
                        <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                            ...
                            @elseif($u_type == 'QA')
                                @if($task_type == 'P1' && $family_business == 0)
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_member_name }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">{{ $family->uin }}</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                        {{ $GenderData[0]->common_values ?? 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_age != '' ? $family_profile[0]->fp_age : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_contact_no != '' ? $family_profile[0]->fp_contact_no : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        {{ $family_profile[0]->fp_aadhar_no != '' ? aadhar($family_profile[0]->fp_aadhar_no) : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_pan != '' ? pan($family_profile[0]->fp_pan) : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">{{ $shg_profile[0]->shgName }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_block != '' ? $family_profile[0]->fp_block : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_district != '' ? $family_profile[0]->fp_district : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_bank_account != '' ? $family_profile[0]->fp_bank_account : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_bank != '' ? $family_profile[0]->fp_bank : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_account_holder != '' ? $family_profile[0]->fp_account_holder : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_account != '' ? account($family_profile[0]->fp_account) : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_bank_branch != '' ? $family_profile[0]->fp_bank_branch : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_spouse_name != '' ? $family_profile[0]->fp_spouse_name : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->shg_member_spouse }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_children_no }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_doughterinlay_no }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_parentinlaws_no }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_family_mamber_over_60year }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_vulnerable_people }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_others_no }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) (int) $family_profile[0]->fp_family_mambers_no }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->non_school_children_no }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_children_no_in_secondary_higher }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->studiedat_home }}
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6">Employed Children</div>
                                                    <div class="col-6">
                                                        {{ (int) $family_profile[0]->fp_employed }}
                                                    </div>
                                                </div>
                                            </div> --}}
                                            <div class="col-md-6">
                                        ...
                                        <div class="row alldetail">
                                            ...
                                            <!-- <div class="col-md-6">
                                                        <div class="row detail">
                                                            ...
                                                            <div class="col-6">
                                                                {{ (int) $family_profile[0]->fp_mamber_no_earn_fixed_income }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="row detail">
                                                            ...
                                                            <div class="col-6">
                                                                {{ (int) $family_profile[0]->fp_mamber_no_earn_seasonal_income }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="row detail">
                                                            ...
                                                            <div class="col-6">
                                                                {{ (int) $family_profile[0]->fp_mamber_no_earn_daily_income }}
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="row detail">
                                                            ...
                                                            <div class="col-6">
                                                                {{ (int) $family_profile[0]->fp_pension_member }}
                                                            </div>
                                                        </div>
                                                    </div> -->
                                            <div class="col-md-6">
                                        ...
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ $employedchildrenData[0]->common_values ?? 'N/A' }}</td>
                                                    <td>{{ $isHealthIssueData[0]->common_values ?? 'N/A' }}</td>
                                                    <td>{{ $insuranceAvlData[0]->common_values ?? 'N/A' }}</td>
                                                    <td>{{ $insuranceTypeData[0]->common_values ?? 'N/A' }}</td>
                                                    <td>{{ $res->policyName }}</td>
                                                    <td>{{ $res->premiumAmount }}</td>
                                                    <td>{{ $frequencyData[0]->common_values ?? 'N/A' }}</td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            ...
                                            @if ($family_profile[0]->gov_liveilhood_program == 1)
                                            <tbody>
                                                <tr>
                                                    <th>Programs</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @for ($i = 0; $i <= $count - 1; $i++) <ul style="list-style-type:disc;">
                                                            <li>{{ $benefis[$i] }}</li>
                                                            </ul>
                                                            @endfor
                                    ...
                                    <div class="card-box">
                                            ...
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">A. Family not educated up to at least six
                                                        ...
                                                        @endphp
                                                    <th>{{ $NotEducatedData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            @if ($family_profile[0]->family_member_not_educated == 1)
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->family_member_not_educatedMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->family_member_not_educatedaFemale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->family_member_not_educatedaTotal }}
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">B. Any children or adolescents up to age of
                                                        ...
                                                        @endphp
                                                        <th>{{ $childrenData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->children_or_adolescents_uptoMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->children_or_adolescents_uptoFemale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->children_or_adolescents_uptoTotal }}
                                                    </td>
                                                </tr>
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">A. Family member have access to all three
                                                        ...
                                                        @endphp
                                                    <th>{{ $NutritionMoralityData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->aNutritionMortalityMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->aNutritionMortalityFeMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->aNutritionMortalityTotal }}
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">B.Does any member suffer due to
                                                        ...
                                                        @endphp
                                                <th>{{ $bNutritionMoralityData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->bNutritionMortalityMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->bNutritionMortalityFeMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->bNutritionMortalityTotal }}
                                                    </td>
                                                </tr>
                                            ...
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">C.Does any one of the children/adolescents
                                                        ...
                                                        @endphp
                                                    <th>{{ $cNutritionMoralityData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            @if ($family_profile[0]->cNutritionMortality == 1)
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->cNutritionMortalityMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->cNutritionMortalityFeMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->cNutritionMortalityTotal }}
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    <th width="100%">D.Have any children or adolescents died
                                                        ...
                                                        @endphp
                                                    <th>{{ $dNutritionMoralityData[0]->common_values ?? 'N/A' }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->dNutritionMortalityMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->dNutritionMortalityFeMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->dNutritionMortalityTotal }}
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                    {{ $SanitizationData[0]->common_values ?? 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                    {{ $ElectricityData[0]->common_values ?? 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                    {{ $DrinkingWaterData[0]->common_values ?? 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                    {{ $CookingFuelData[0]->common_values ?? 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    ...
                                                    <th>{{ $family_profile[0]->sHealthIssues }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Male</td>
                                                    <td>{{ $family_profile[0]->sHealthIssuesMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Female</td>
                                                    <td>{{ $family_profile[0]->sHealthIssuesFeMale }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. Total</td>
                                                    <td>{{ $family_profile[0]->sHealthIssuesTotal }}
                                                    </td>
                                                </tr>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        @endphp
                                                        <td>{{ $MigratedData[0]->common_values ?? 'N/A' }}</td>
                                                    </div>
                                                </div>
                                            </div>
                                            @if ($family_profile[0]->fp_family_migrated == 1)
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6">Member Reason Of Migration
                                                    </div>
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->fp_family_reason_of_migration }}
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="row alldetail">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $family_profile[0]->sDrinkingWater }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="card-box">
                                        <div class="row alldetail">
                                            ...
                                            @if ($family_profile[0]->fp_family_migrated == 'Yes')
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6">Member Reason Of Migration
                                                    </div>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="card-box">
                                        <div class="row alldetail">
                                            ...
                                            @if($assets[0]->fa_land_mortgaged == 'Yes')
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6">How much land</div>
                                                    <div class="col-6">
                                                        {{ $assets[0]->fa_mortagged_how_much_land != '' ? number_format($assets[0]->fa_mortagged_how_much_land,2) : '0.00' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        ...
                                                        {{-- {{ change_date_month_name_char(22/Aug/2022) }} --}}
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $assets[0]->house_ownership != '' ? $assets[0]->house_ownership : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $assets[0]->fa_Pacca_Kaccha_house != '' ? $assets[0]->fa_Pacca_Kaccha_house : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $assets[0]->fa_animalsheds != '' ? $assets[0]->fa_animalsheds : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ checkna($row->vehicle_Types) }}</td>
                                                    <td>{{ $row->no_of_vehicle != '' ? $row->no_of_vehicle : 0 }}
                                                    </td>
                                                </tr>
                                                @endforeach
                                                @endif
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ checkna($row->machinery_Types) }}</td>
                                                    <td>{{ $row->no_of_machinery != '' ? $row->no_of_machinery : 0 }}
                                                    </td>
                                                </tr>
                                                @endforeach
                                                @endif
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>{{ $row->animal_Types }}</td>
                                                    <td>{{ $row->no_of_animals != '' ? $row->no_of_animals : 0 }}
                                                    </td>
                                                </tr>
                                                @endforeach
                                                @endif
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="card-box">
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                @if (!empty($assets_gadgets))
                                                <tr>
                                                    <td>Tv color</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_tvcolor == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Tv black/white</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_tvblackwhite == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Air conditioners</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_airconditioners == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Coolers</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_coolers == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Sewing Machines</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_sewingmachines == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Smartphone</td>
                                                    <td>{{ (int) $assets_gadgets[0]->fa_smartphone == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Wet Grinder</td>
                                                    <td>{{ (int) $assets_gadgets[0]->wet_grinder == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Mixi</td>
                                                    <td>{{ (int) $assets_gadgets[0]->mixi == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Washing Machines</td>
                                                    <td>{{ (int) $assets_gadgets[0]->washing_machines == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Computer</td>
                                                    <td>{{ (int) $assets_gadgets[0]->computer == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Refrigerator</td>
                                                    <td>{{ (int) $assets_gadgets[0]->refrigerator == 1 ? 'Yes' : 'No' }}
                                                    </td>
                                                </tr>
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    ...
                                                    <th>{{ checkna($assets[0]->fa_jewelry_yes_no) }}</th>
                                                </tr>
                                            </thead>
                                        </table>
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    ...
                                                    <th>{{ checkna($assets[0]->jewelry_pawned_take_loan_yesno) }}
                                                    </th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Lender Type</td>
                                                    <td>{{ checkna($assets[0]->jewelry_pawned_lander_type) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Amount</td>
                                                    <td>{{ (float) $assets[0]->jewelry_pawned_loan_amount != '' ? (float) $assets[0]->jewelry_pawned_loan_amount : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. When/date</td>
                                                    <td>{{ $assets[0]->jewelry_pawned_loan_when != '' ?  $assets[0]->jewelry_pawned_loan_when : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iv. Interest rate</td>
                                                    <td>{{ $assets[0]->jewelry_pawned_loan_interest != '' ? $assets[0]->jewelry_pawned_loan_interest : 0 }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                            @endif
                                        ...
                                        <table class="table mytable">
                                            <thead class="back-color">
                                                <tr>
                                                    ...
                                                    <th>{{ checkna($assets[0]->jewelry_pawned_lost_yesno) }}</th>
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>i. Lender Type</td>
                                                    <td>{{ $assets[0]->jewelry_pawned_lander_lost_type }}</td>
                                                </tr>
                                                <tr>
                                                    <td>ii. Amount</td>
                                                    <td>{{ (int) $assets[0]->jewelry_pawned_loan_lost_amount != '' ? (int) $assets[0]->jewelry_pawned_loan_lost_amount : 0 }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>iii. When/date</td>
                                                    <td>{{ $assets[0]->jewelry_pawned_loan_lost_when }}</td>
                                                </tr>
                                                <tr>
                                                    <td>iv. Interest rate</td>
                                                    <td>{{ $assets[0]->jewelry_pawned_loan_lost_interest != '' ? $assets[0]->jewelry_pawned_loan_lost_interest : 0 }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                            @endif
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ checkna($assets[0]->fa_other_assets_A) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ checkna($assets[0]->fa_other_assets_B) }}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ checkna($assets[0]->fa_other_assets_C ) }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ checkZero($assets[0]->fa_other_assets_D) }}
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Agriculture</td>
                                                <td>{{ $aggriculture_this[0]->cy_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $aggriculture_this[0]->id ?? 0}}" href="#exampleModalCenter2" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter2"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $aggriculture_next[0]->ny_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $aggriculture_next[0]->id ?? 0 }}" href="#exampleModalCenter3" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter3"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>Live Stock</td>
                                                <td>{{ $live_this[0]->cy_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $live_this[0]->id ?? 0 }}" href="#exampleModalCenter2" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter2"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $live_next[0]->ny_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $live_next[0]->id ?? 0 }}" href="#exampleModalCenter3" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter3"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>Horticultural </td>
                                                <td>{{ $Horticultural_this[0]->cy_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $Horticultural_this[0]->id ?? 0 }}" href="#exampleModalCenter2" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter2"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $Horticultural_next[0]->ny_total }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $Horticultural_next[0]->id ?? 0 }}" href="#exampleModalCenter3" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter3"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>

                                            <tr class="total">
                                                <td colspan="1">Total</td>
                                                <td>{{ (int) $aggriculture_this[0]->cy_total + (int) $live_this[0]->cy_total + (int) $Horticultural_this[0]->cy_total }}
                                                </td>
                                                <td></td>
                                                <td>{{ (int) $aggriculture_next[0]->ny_total + (int) $live_next[0]->ny_total + (int) $Horticultural_next[0]->ny_total }}
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                            ...
                            <div class="tab-pane fade" id="v-pills-Savings" role="tabpane" aria-labelledby="v-pills-Savings-tab">
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>{{ $savings[0]->s_passbook_physically == 1 ? 'Yes' : 'No' }}
                                                </td>
                                                <td>{{ $savings[0]->s_passbook_updated == 1 ? 'Yes' : 'No' }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $row['s_type'] }}</td>
                                                <td>{{ $row['s_contribute_regular'] }}
                                                </td>
                                                <td>{{ $row['s_started_from'] }}
                                                </td>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            @php $sum_a=$sum_a+(float)$row->other_amount; @endphp
                                            <tr>
                                                <td>{{ checkna($row->other_loan) }}</td>
                                                <td>{{ checkna($row->other_where_fixed_deposit_made) }}</td>
                                                <td>{{ $row->other_date_of_deposit != '' ? change_date_month_name_char(str_replace('/', '-', $row->other_date_of_deposit)) : 'N/A' }}
                                                </td>
                                                <td>{{ $row->other_fixed_deposit_term_period != '' ? $row->other_fixed_deposit_term_period : 0 }}
                                                </td>
                                                <td>{{ $row->other_interest != '' ? $row->other_interest : 0 }}
                                                </td>
                                                <td>{{ $row->last_saved_amt }}
                                                </td>
                                                <td>{{ $row->other_amount != '' ? $row->other_amount : 0 }}
                                                </td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingOne">
                                            <table class="table mytable">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <th>SHG Loan</th>
                                                        <th>{{ $Shg_loan[0]->total_principle }}</th>
                                                        <th>{{ $Shg_loan[0]->total_paid }}</th>
                                                        <th>{{ $Shg_loan[0]->cumulative }}</th>
                                                        <th>{{ $Shg_loan[0]->overdue }}</th>
                                                        <th>{{ $Shg_loan[0]->loan_next }}</th>
                                            ...
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ $money_loan[0]->total_principle }}</th>
                                                        <th>{{ $money_loan[0]->total_paid }}</th>
                                                        <th>{{ $money_loan[0]->cumulative }}</th>
                                                        <th>{{ $money_loan[0]->overdue }}</th>
                                                        <th>{{ $money_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            ...
                                                            <td colspan="">{{ $sum_m4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_m }}</td>
                                                            <td colspan="">{{ $sum_m2 }}</td>
                                                            <td colspan="">{{ $sum_m3 }}</td>
                                                            <td>{{ $sum_m5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingThree">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        <th>BANK LOAN</th>
                                                        <th>{{ $bank_loan[0]->total_principle }}</th>
                                                        <th>{{ $bank_loan[0]->total_paid }}</th>
                                                        <th>{{ $bank_loan[0]->cumulative }}</th>
                                                        <th>{{ $bank_loan[0]->overdue }}</th>
                                                        <th>{{ $bank_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_b1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_b4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_b }}</td>
                                                            <td colspan="">{{ $sum_b2 }}</td>
                                                            <td colspan="">{{ $sum_b3 }}</td>
                                                            <td>{{ $sum_b5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingFour">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        <th>NBFC LOAN</th>
                                                        <th>{{ $nbfc_loan[0]->total_principle }}</th>
                                                        <th>{{ $nbfc_loan[0]->total_paid }}</th>
                                                        <th>{{ $nbfc_loan[0]->cumulative }}</th>
                                                        <th>{{ $nbfc_loan[0]->overdue }}</th>
                                                        <th>{{ $nbfc_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_v1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_v4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_v }}</td>
                                                            <td colspan="">{{ $sum_v2 }}</td>
                                                            <td colspan="">{{ $sum_v3 }}</td>
                                                            <td>{{ $sum_v5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingFive">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        <th>CLUSTER LOAN</th>
                                                        <th>{{ $cluster_loan[0]->total_principle }}</th>
                                                        <th>{{ $cluster_loan[0]->total_paid }}</th>
                                                        <th>{{ $cluster_loan[0]->cumulative }}</th>
                                                        <th>{{ $cluster_loan[0]->overdue }}</th>
                                                        <th>{{ $cluster_loan[0]->loan_next }}</th>
                                        ...
                                        <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                                            <div class="table-responsive text-nowrap">
                                                <table class="table mytable">
                                                    ...
                                                    @endphp
                                                    <tbody>
                                                        @foreach ($cluster_loan_de as $res)
                                                        @php
                                                        $loan_tenure = '';
                                                        if ($res->lo_tenure_mode == 0) {
                                                        $loan_tenure = $res->lo_no_of_tenure . '-' . 'Month';
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_c1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_c4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_c }}</td>
                                                            <td colspan="">{{ $sum_c2 }}</td>
                                                            <td colspan="">{{ $sum_c3 }}</td>
                                                            <td>{{ $sum_c5 }}</td>
                                                        </tr>
                                            ...
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>{{ $fed_loan[0]->total_principle }}</th>
                                                        <th>{{ $fed_loan[0]->total_paid }}</th>
                                                        <th>{{ $fed_loan[0]->cumulative }}</th>
                                                        <th>{{ $fed_loan[0]->overdue }}</th>
                                                        <th>{{ $fed_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_f1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_f4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_f }}</td>
                                                            <td colspan="">{{ $sum_f2 }}</td>
                                                            <td colspan="">{{ $sum_f3 }}</td>
                                                            <td>{{ $sum_f5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingSix">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        <th>MFI LOAN</th>
                                                        <th>{{ $mfi_loan[0]->total_principle }}</th>
                                                        <th>{{ $mfi_loan[0]->total_paid }}</th>
                                                        <th>{{ $mfi_loan[0]->cumulative }}</th>
                                                        <th>{{ $mfi_loan[0]->overdue }}</th>
                                                        <th>{{ $mfi_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_mf1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_mf4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_mf }}</td>
                                                            <td colspan="">{{ $sum_mf2 }}</td>
                                                            <td colspan="">{{ $sum_mf3 }}</td>
                                                            <td>{{ $sum_mf5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingSeven">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr>
                                                        <th>OTHER LOAN</th>
                                                        <th>{{ $other_loan[0]->total_principle }}</th>
                                                        <th>{{ $other_loan[0]->total_paid }}</th>
                                                        <th>{{ $other_loan[0]->cumulative }}</th>
                                                        <th>{{ $other_loan[0]->overdue }}</th>
                                                        <th>{{ $other_loan[0]->loan_next }}</th>
                                                ...
                                                <table class="table mytable">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr class="total">
                                                            <td>{{ $sum_o1 }}</td>
                                                            <td colspan="9"></td>
                                                            <td colspan="">{{ $sum_o4 }}</td>
                                                            <td colspan=""></td>
                                                            <td colspan="">{{ $sum_o }}</td>
                                                            <td colspan="">{{ $sum_o2 }}</td>
                                                            <td colspan="">{{ $sum_o3 }}</td>
                                                            <td>{{ $sum_o5 }}</td>
                                                        </tr>
                                        ...
                                        <div class="table-responsive text-nowrap" id="headingSeven">
                                            <table class="table mytable">
                                                <thead>
                                                    <tr class="total">
                                                        <td>Total</td>
                                                        <td>{{ $loan_total[0]->principle }}</td>
                                                        <td>{{ $loan_total[0]->total_paid }}</td>
                                                        <td>{{ $loan_total[0]->cumulative }}</td>
                                                        <td>{{ $loan_total[0]->overdue }}</td>
                                                        <td>{{ $loan_total[0]->next }}</td>
                                                        <td></td>
                                                    </tr>
                                                </thead>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>Livestock</td>
                                                <td>{{ !empty($income_this_year[0]->livestock) ? (int) $income_this_year[0]->livestock : 0 }}
                                                </td>
                                                <td></td>
                                                <td>{{ !empty($income_next_year[0]->livestock) ? (int) $income_next_year[0]->livestock : 0 }}
                                                </td>
                                                <td></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><a data-toggle="modal" data-id="{{ $fixed_income[0]->ids ?? 0 }}" data-val="1" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                                <td>{{ !empty($income_next_year[0]->fixed_income_amount) ? (int) $income_next_year[0]->fixed_income_amount  : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $fixed_income_next[0]->ids ?? 0 }}" data-val="2" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Casual Income</td>
                                                ...
                                                <td><a data-toggle="modal" data-id="{{ $casual_income[0]->ids ?? 0  }}" data-val="1" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                                <td>{{ !empty($income_next_year[0]->casual_income_amount) ? (int) $income_next_year[0]->casual_income_amount  : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $casual_income_next[0]->ids ?? 0}}" data-val="2" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Trade Income</td>
                                                ...
                                                <td><a data-toggle="modal" data-id="{{ $trade_income[0]->ids ?? 0 }}" data-val="1" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                                <td>{{ !empty($income_next_year[0]->trade_income_amount) ? (int) $income_next_year[0]->trade_income_amount  : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $trade_income_next[0]->ids ?? 0 }}" data-val="2" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td><a data-toggle="modal" data-id="{{ $pension_income[0]->ids ?? 0 }}" data-val="1" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                                <td>{{ !empty($income_next_year[0]->pension_income_monthly) ? (int) $income_next_year[0]->pension_income_monthly : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $pension_income_next[0]->ids ?? 0 }}" data-val="2" href="#exampleModalCenter9" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter9"><i class="c-white-500 ti-eye"></i></a>
                                                </td>
                                            </tr>
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $normal_exp_this[0]->cy_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $normal_exp_this[0]->id }}" href="#exampleModalCenter4" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter4"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $normal_exp_next[0]->ny_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $normal_exp_next[0]->id }}" href="#exampleModalCenter5" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter5"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>Social Expenditure</td>
                                                <td>{{ $social_exp_this[0]->cy_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $social_exp_this[0]->id }}" href="#exampleModalCenter4" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter4"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $social_exp_next[0]->ny_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $social_exp_next[0]->id }}" href="#exampleModalCenter5" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter5"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>Wasteful Expenditure</td>
                                                <td>{{ $waste_exp_this[0]->cy_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $waste_exp_this[0]->id }}" href="#exampleModalCenter4" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter4"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $waste_exp_next[0]->ny_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $waste_exp_next[0]->id }}" href="#exampleModalCenter5" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter5"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>

                                            <tr>
                                                <td>Production/Business Expenses</td>
                                                <td>{{ $prod_exp_this[0]->cy_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $prod_exp_this[0]->id }}" href="#exampleModalCenter4" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter4"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ $prod_exp_next[0]->ny_total }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $prod_exp_next[0]->id }}" href="#exampleModalCenter5" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter5"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>

                                            <tr>
                                                <td>Loan Expenditure</td>
                                                <td>{{ !empty($loan_outstanding_budget[0]->cy_value) ? $loan_outstanding_budget[0]->cy_value : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $loan_outstanding_budget[0]->id }}" href="#exampleModalCenter6" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter6"><i class="c-white-500 ti-eye"></i></a></td>
                                                <td>{{ !empty($loan_outstanding_budget[0]->ny_value) ? $loan_outstanding_budget[0]->ny_value : 0 }}
                                                </td>
                                                <td><a data-toggle="modal" data-id="{{ $loan_outstanding_budget[0]->id }}" href="#exampleModalCenter7" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter7"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>

                                            <tr>
                                                <td>Savings</td>
                                                <td>{{ $saving_total[0]->saving_total }}</td>
                                    ...
                                    <table class="table mytable table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $analysis_1_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show1_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_1_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show1_ny }} '></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                ...
                                                <td>{{ $analysis_2_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show2_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_2_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show2_ny }} '></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>B</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $analysis_3_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show3_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_3_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show3_cy }} '></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $analysis_4_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show4_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_4_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show4_cy }} '></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>2</td>
                                                <td>{{ $analysis_other }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show_other }} '></div>
                                                </td>
                                                <td>{{ $analysis_other }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show_other }} '></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $analysis_5_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show5_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_5_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show5_ny }} '></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>7</td>
                                                ...
                                                <td>{{ $analysis_6_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show6_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_6_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show6_cy }} '></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $analysis_7_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show7_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_7_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show7_ny }} '></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>9</td>
                                                ...
                                                <td>{{ $analysis_8_cy }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show8_cy }} '></div>
                                                </td>
                                                <td>{{ $analysis_8_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show8_ny }} '></div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>10</td>
                                                ...
                                                <td>{{ $analysis_10_cy }}</td>

                                                <td>
                                                    <div class='status_analysis {{ $show10_cy }} '></div>
                                                </td>
                                            ...
                                            {{-- <tr>
                                                    <td>11</td>
                                                    <td></td>
                                                    <td>Total overdue all other loans</td>
                                                    <td>5</td>
                                                    <td>{{ $analysis_10_cy }}</td>
                                            ...
                                            <tr>
                                                ...
                                                <td>10</td>
                                                <td>{{ $analysis_11_cy }}</td>

                                                <td>
                                                    <div class='status_analysis {{ $show11_cy }} '></div>
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>10</td>
                                                <td>{{ $analysis_12_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show12_ny }} '></div>
                                                </td>
                                                <td>{{ $analysis_12_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show12_ny }} '></div>
                                            ...
                                            <tr>
                                                ...
                                                <td>2</td>
                                                <td>{{ $analysis_13_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show13_ny }} '></div>
                                                </td>
                                                <td>{{ $analysis_13_ny }}</td>
                                                <td>
                                                    <div class='status_analysis {{ $show13_ny }} '></div>
                            ...
                            <div class="tab-pane fade" id="v-pills-Business-Plan" role="tabpanel" aria-labelledby="v-pills-Business-Plan-tab">
                                ...
                                <div class="family-box mt-3">
                                    <div class="card-box">
                                        <table class="table table-bordered  mytable">
                                            <tr>
                                                <th>Member name</th>
                                                <td>{{ $family_profile[0]->fp_member_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>Name of SHG</th>
                                                <td>{{ $shg_profile[0]->shgName }}</td>
                                            </tr>
                                            <tr>
                                                <th>Aadhar Card No</th>
                                                <td>{{ aadhar($family_profile[0]->fp_aadhar_no) }}</td>
                                            </tr>
                                            <tr>
                                                <th>Husband Name</th>
                                                <td>{{ $family_profile[0]->fp_spouse_name }}</td>
                                            </tr>
                                            <tr>
                                                <th>Mobile Number</th>
                                                <td>{{ (int) $family_profile[0]->fp_contact_no }}</td>
                                            </tr>
                                            <tr>
                                            ...
                                            <div class="row alldetail">
                                                <div class="col-md-6">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ $business_investment_plan[0]->is_buisness_plan_avl  }}
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="row detail">
                                                        ...
                                                        <div class="col-6">
                                                            {{ $business_investment_plan[0]->comments  }}
                                                        </div>
                                                    </div>
                                                </div>
                                                @endif
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <th>Improving on exixting business or adding to the current
                                                        business</th>
                                                    <td>{{ checkna($business_investment_plan[0]->current_business) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">B</th>
                                                    <th>Friend/Relative in this new business</th>
                                                    <td>{{ checkna($business_investment_plan[0]->friend_relative_new_business) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">C</th>
                                                    <th>Market demand for this business</th>
                                                    <td>{{ checkna($business_investment_plan[0]->market_demand_business) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">D</th>
                                                    <th>Proposed activity</th>
                                                    <td>{{ checkna($business_investment_plan[0]->proposed_activity_new) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">E</th>
                                                    <th>Identified your competitors</th>
                                                    <td>{{ checkna($business_investment_plan[0]->have_competitors) }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    <th scope="row">F</th>
                                                    <th>Specify</th>
                                                    <td>{{ checkna($business_investment_plan[0]->if_yes_specify_competitors) }}
                                                    </td>
                                                </tr>
                                                @endif
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ checkna($business_investment_plan[0]->how_long_family_business) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">C</th>
                                                    <th>Reason for expnsion</th>
                                                    <td>{{ checkna($business_investment_plan[0]->reasons_expansion) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">D</th>
                                                    <th>Proposed activity</th>
                                                    <td>{{ checkna($business_investment_plan[0]->proposed_activity_existing) }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="row">E</th>
                                                    <th>Do you know where you would be selling your product</th>
                                                    <td>{{ checkna($business_investment_plan[0]->selling_product) }}
                                                    </td>
                                                </tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ checkna($business_investment_plan[0]->if_yes_specify) }}
                                                    </td>
                                                </tr>
                                                @endif
                                                @endif
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{ checkna($business_investment_plan[0]->primarily_business) }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                ...
                                <div div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            @if (!empty($yearly_operational_expenses[0]->expenses_type))
                                            @foreach ($yearly_operational_expenses as $row)
                                            <tr>
                                                <td>{{ $row->expenses_type }}</td>
                                                <td>{{ $row->YearExpense }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $row->id }}" href="#exampleModalCenter" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            @if (!empty($income_from_business[0]->income_type))
                                            @foreach ($income_from_business as $row)
                                            <tr>
                                                <td>{{ $row->income_type }}</td>
                                                <td>{{ $row->YearIncome }}</td>
                                                <td><a data-toggle="modal" data-id="{{ $row->id }}" href="#exampleModalCenter1" class="btn btn-success btn-link btn-sm" data-target="#exampleModalCenter1"><i class="c-white-500 ti-eye"></i></a></td>
                                            </tr>
                                            @endforeach
                                            @endif
                                        </tbody>
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-12">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">{{ (int) $fixed_assets }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ (float) $first_year_total_salesamts }}</td>
                                                <td>{{ (float) $scnd_year_total_salesamts }}</td>
                                                <td>{{ (float) $trd_year_total_salesamts }}</td>
                                            </tr>

                                            <tr>
                                                <td>Loan Repayment</td>
                                                <td>{{ (float) $first_year_total_loanamts_fyear }}</td>
                                                <td>{{ (float) $scnd_year_total_loanamts_fyear }}</td>
                                                <td>{{ (float) $trd_year_total_loanamts_fyear }}</td>
                                            </tr>

                                            <tr>
                                                <td>Interest Repayment</td>
                                                <td>{{ (float) $first_year_total_interestamts_fyear }}</td>
                                                <td>{{ (float) $scnd_year_total_interestamts_fyear }}</td>
                                                <td>{{ (float) $trd_year_total_interestamts_fyear }}</td>
                                            </tr>
                                            <tr style="background-color: orange;color: #1630e2;font-weight: bolder;font-size: medium;">
                                                <td>Total</td>
                                                <td>{{ (float) $first_year_expansesamt }}</td>
                                                <td>{{ (float) $scnd_year_expansesamt }}</td>
                                                <td>{{ (float) $trd_year_expansesamt }}</td>
                                            </tr>
                                            <tr>
                                                <td>Income</td>
                                                <td>{{ (float) $first_year_total_incomeamts }}</td>
                                                <td>{{ (float) $scnd_year_total_incomeamts }}</td>
                                                <td>{{ (float) $trd_year_total_incomeamts }}</td>
                                            </tr>
                                            <tr style="background-color: #b3aeae;color: #1630e2;font-weight: bolder;font-size: medium;">
                                                <td>Profit/Loss</td>
                                                <td class="{{ $show1 }}">{{ (float) $tv_1profit }}</td>
                                                <td class="{{ $show2 }}">{{ (float) $tv_2profit }}</td>
                                                <td class="{{ $show3 }}">{{ (float) $tv_3profit }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                    <div class="card-box">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="tdc">
                                                ...
                                                <td>{{ checkper($loan_repayment[0]->interest) }}%</td>
                                                @else
                                                <td>0.00%</td>
                                                @endif
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $loan_repayment[0]->total_interest_fyear != '' ? $loan_repayment[0]->total_interest_fyear : 0 }}
                                                </td>
                                                <td>{{ $loan_repayment[0]->total_interest_syear != '' ? $loan_repayment[0]->total_interest_syear : 0 }}
                                                </td>
                                                <td>{{ $loan_repayment[0]->total_interest_thyear != '' ? $loan_repayment[0]->total_interest_thyear : 0 }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>Total Principle</td>
                                                <td>{{ $loan_repayment[0]->total_loan_fyear != '' ? $loan_repayment[0]->total_loan_fyear : 0 }}
                                                </td>
                                                <td>{{ $loan_repayment[0]->total_loan_syear != '' ? $loan_repayment[0]->total_loan_syear : 0 }}
                                                </td>
                                                <td>{{ $loan_repayment[0]->total_loan_thyear != '' ? $loan_repayment[0]->total_loan_thyear : 0 }}
                                                </td>
                                            </tr>
                                            <tr>
                                                @php
                                ...
                                <div class="family-box">
                                    ...
                                    <table class="table table-bordered  mytable">
                                        ...
                                        <tbody>
                                            ...
                                            @if ($shgmember_commitment[0]->yo_meeting_yes_no == 'Yes')
                                            <tr>
                                                <th scope="row"></th>
                                                <th>No. of meetings attended during last 12 months ?</th>
                                                <td>{{ checkna($shgmember_commitment[0]->yo_meeting_attend) }}
                                                </td>
                                            </tr>
                                            @else
                                            <tr>
                                                ...
                                                <td>{{ checkna($shgmember_commitment[0]->yo_metting_not_attend) }}
                                                </td>
                                            </tr>
                                            @endif
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ checkna($shgmember_commitment[0]->yo_member_aware_categories) }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="row">3</th>
                                            ...
                                            @if ($shgmember_commitment[0]->yo_somewhat_yes_no != 'No')
                                            <tr>
                                                <th scope="row"></th>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ checkna($shgmember_commitment[0]->yo_family_member_not_participate) }}
                                                </td>
                                            </tr>
                                            @endif
                                        </tbody>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $observation_next_year[0]->fdip_observation_next_business }}
                                                    ...
                                                    @if ($observation_next_year[0]->fdip_observation_next_business == 'Yes')
                                                    <br>
                                                    <ol type="A">
                                ...
                                <div class="family-box">
                                    ...
                                    <div class="family-box">
                                        ...
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                @foreach ($photos_first_year as $image_first_year)
                                    ...
                                    <div class="family-box">
                                        ...
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                @foreach ($photos_second_year as $image_second_year)
                                                @if ($image_second_year->imagename != '')
                                                <tr class="text-center">
                                                    <th><img src="/assets/uploads/{{ $image_second_year->imagename }}" height="100" width="100"></th>
                                                </tr>
                                                @endif
                                                @endforeach
                                            </tbody>
                            ...
                            <div class="tab-pane fade" id="v-pills-consent" role="tabpanel" aria-labelledby="v-pills-consent-tab">
                                <div class="family-box">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            @if ($concent[0]->name_of_participant != '')
                                            <tr class="text-center">
                                                <th>{{ $concent[0]->name_of_participant }}</th>
                                                <th><img src="/signature/fac_{{ $mst_id }}.png" height="100" width="100"></th>
                                                <th>Participant</th>
                                            </tr>
                                            @else
                                            <tr class="text-center">
                                            ...
                                            @endif
                                            @if ($concent[0]->name_of_facilitator != '')
                                            <tr class="text-center">
                                                <th>{{ $concent[0]->name_of_facilitator }}</th>
                                                <th><img src="/signature/par_{{ $mst_id }}.png" height="100" width="100"></th>
                                                <th>Facilitator</th>
                                            </tr>
                                            @else
                                                <tr class="text-center">
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ $loan_approvel[0]->uloan_amount }}" name="uloan_amount" id="uloan_amount" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            <label for="validationCustom02">Updated Purpose</label>
                                            <input type="text" value="{{ $loan_approvel[0]->uloan_purpose }}" id="uloan_pur" name="uloan_pur" class="form-control" autocomplete="off">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <select class="form-control" id="uloan_duration" name="uloan_duration" required>
                                                ...
                                                @for ($i = 1; $i <= 36; $i++) <option class="uloan_duration1" value="{{ $i }}" {{ !empty($loan_approvel[0]->uloan_duration) && $loan_approvel[0]->uloan_duration == $i ? 'selected' : '' }}>
                                                    {{ $i }}</option>
                                                    @endfor
                                            </select>
                                        </div>
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" value="{{ $loan_approvel[0]->uloan_installments }}" id="uloan_installments" name="uloan_installments" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    @if ($locked == 1)
                                    @if ($u_type == 'M')
                                    <div class="row">
                                        <div class="col-md-12 mb-3 text-center">
                                            <input type="hidden" name="family_sub_mst" id="family_sub_mst" value="{{ $mst_id }}">
                            ...
                            <div class="tab-pane fade" id="v-pills-loan-approved" role="tabpanel" aria-labelledby="v-pills-loan-approved-tab">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $loan_repayment[0]->principal }}</td>
                                                <td>{{ $business_investment_plan[0]->type_of_business }}</td>
                                                <td>{{ $loan_repayment[0]->tenure_mode == 1 ? 'Yearly' : 'Monthly' }}
                                                </td>
                                                <td>{{ $loan_duration }}</td>
                                                <td>{{ $loan_tenure }}</td>
                                            </tr>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            @if (!empty($loan_approvel))
                                            <tr>
                                                <td>{{ $loan_approvel[0]->get_verified }}</td>
                                                <td>{{ $loan_approvel[0]->uloan_amount }}</td>
                                                <td>{{ $loan_approvel[0]->uloan_purpose }}</td>
                                                <td>{{ $loan_approvel[0]->urepayment_mode }}</td>
                                                <td>{{ $loan_approvel[0]->uloan_duration }}</td>
                                                <td>{{ $loan_approvel[0]->uloan_installments }}</td>
                                            </tr>
                                            @endif
                                        </tbody>
                                    </table>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <table class="table mytable">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ !empty($manager[0]->name) ? $manager[0]->name : '' }}</td>

                                                <td>{{ $loan_approvel[0]->date != '' ? change_date_month_name_char(str_replace('/', '-', $loan_approvel[0]->date)) : '' }}
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 mb-3">
                                            ...
                                            <input type="text" value="{{ !empty($loan_disbursement[0]->disbursement_date) ? $loan_disbursement[0]->disbursement_date : '' }}" name="loan_date" id="loan_date" class="form-control datepicker" placeholder="date">
                                        </div>
                                        <div class="col-md-4 mb-3">
                                            <label for="validationCustom02">Final loan amount after
                                                disbursement</label>
                                            <input type="text" value="{{ !empty($loan_disbursement[0]->loan_amount) ? $loan_disbursement[0]->loan_amount : '' }}" id="loan_amount" name="loan_amount" class="form-control" autocomplete="off">
                                        </div>
                                    </div>
                                    ...
                                    <div id="loan_changes">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" value="{{ !empty($loan_disbursement[0]->loan_purpose) ? $loan_disbursement[0]->loan_purpose : '' }}" id="loan_purpose" name="loan_purpose" class="form-control ">
                                            </div>
                                            <div class="col-md-6 mb-3">
                                            ...
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <select class="form-control" id="loan_duration" name="loan_duration" required>
                                                    ...
                                                    @for ($i = 1; $i <= 36; $i++) <option class="loan_duration1" value="{{ $i }}" {{ !empty($loan_disbursement[0]->loan_duration) && $loan_disbursement[0]->loan_duration == $i ? 'selected' : '' }}>
                                                        {{ $i }}</option>
                                                        @endfor
                                                </select>
                                            </div>
                                            <div class="col-md-6 mb-3">
                                                ...
                                                <input type="text" value="{{ !empty($loan_disbursement[0]->no_installments) ? $loan_disbursement[0]->no_installments : '' }}" id="loan_installments" name="loan_installments" class="form-control" autocomplete="off">
                                            </div>
                                        ...
                                        <table class="table table-bordered mytable" colspan="2">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td width="50%">{{ $family_profile[0]->fp_member_name }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Aadhar No</th>
                                                    <td>{{ $family_profile[0]->fp_aadhar_no != '' ? aadhar($family_profile[0]->fp_aadhar_no) : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>UIN</th>
                                                ...
                                                <tr>
                                                    <th>State Name</th>
                                                    <td>{{ checkna($family_profile[0]->fp_state) }}</td>
                                                </tr>
                                                <tr>
                                                    <th>District Name</th>
                                                    <td>{{ $family_profile[0]->fp_district != '' ? $family_profile[0]->fp_district : 'N/A' }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th>Village Name</th>
                                                    <td>{{ $family_profile[0]->fp_village }}</td>
                                                </tr>
                                                <tr>
                                                    <th>Date</th>
                                                    <td>{{ change_date_month_name_char(str_replace('/', '-', $family->created_at)) }}
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table table-bordered mytable" colspan="2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ URL::to('/familyPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <th width="50%">Family Profile With Report Card</th>
                                                    <td><a href="{{ URL::to('/familyDetailCardPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <th>Family Report Card </th>
                                                    <td><a href="{{ URL::to('/familycardPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>

                                                <tr>
                                                    <th>Family Buisness Plan </th>
                                                    <td> <a href="{{ URL::to('/familyBusinessplanPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2">
                                                            <i class="las ti-download"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <th>Family Loan Disbursement</th>
                                                    <td><a href="{{ URL::to('/familyloanPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <th>Family Loan Application</th>
                                                    <td><a href="{{ URL::to('/familyloanApplicationPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <th>Family Consent Form</th>
                                                    <td><a href="{{ URL::to('/familyConsentPdf/' . $family_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    ...
                                    <div class="family-box mt-3">
                                        ...
                                        <div class="card-box">
                                            ...
                                            <div class="col-sm-8 text-center">
                                                <input type="hidden" name="family_flag" id="family_flag"  value="{{ $family_flag }}">
                                                ...
                                                <input type="hidden" name="task_status" id="task_status" value="{{ $task_status }}">
                                                <input type="hidden" name="task_type" id="task_type" value="{{ $task_type }}">
                                                <input type="hidden" name="task_status_qa_p1" id="task_status_qa_p1" value="{{ $task_status_qa_p1 }}">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="" style="overflow-y: scroll; height:400px;">
                <table class="table mytable">
                    {{-- <thead>
                                <tr>
                                    <td colspan="6"><h5>Saving Source</h5></td>
                                </tr>
                            </thead> --}}
                    <thead class="back-color">
                    ...
                    {{-- <thead>
                                      <tr>
                                        <td colspan="6"><h5>Other Savings Source</h5></td>
                                      </tr>
                                </thead> --}}
                    <thead class="back-color">
                        {{-- <tr>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $row->last_saved_amt != '' ? $row->last_saved_amt : 0 }}
                            </td>
                        </tr>
                        @endforeach
                        @endif
                        <tr class="total">
                            <td colspan="">Total</td>
                            <td>{{ $saving_total[0]->saving_total ?? 0 }}</td>
                        </tr>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: ["Rating", ""],
                datasets: [{
                    data: ['{{ $grand_total_cy }}', '{{ 100 - $grand_total_cy }}'],
    ...
    $(document).ready(function() {
        ...
        var to = "{{ !empty($loan_approvel[0]->date) ? $loan_approvel[0]->date : '' }}";
