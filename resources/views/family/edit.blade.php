                                ...
                                <form class="container" method="POST" action="{{ route('family.update', $family->id) }}" autocomplete="off">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="fp_member_name"  value="{{  $family_profile[0]->fp_member_name }}" autocomplete="off" required style="pointer-events: none" readonly="readonly">
                                        </div>
                                        <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="fp_spouse_name"  value="{{  $family_profile[0]->fp_spouse_name }}" autocomplete="off" required style="pointer-events: none" readonly>
                                        </div>
