...
@section('content')
        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-lg-8">
                    ...
                    @php $session_data = Session::get('family_session'); @endphp
        ...
        <div class="card">
            <div class="card-block pt-2 pb-2">
                <div class="mT-30">
                    ...
                    <form class="" method="post" action="{{ url('getLatLongFamily') }}">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <select class="form-control" name="country" id="country">
                                    ...
                                    @foreach ($countries as $row)
                                        <option value="{{ $row->id }}"
                                            {{ !empty(Session::get('family_session')['country']) && Session::get('family_session')['country'] == $row->id ? 'selected' : '' }}>
                                            {{ $row->name }}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <select class="form-control agency_id" name="agency_id" id="agency_id">
                                    ...
                                    @foreach ($agency as $row)
                                        <option value="{{ $row->agency_id }}"
                                            {{ !empty(Session::get('family_session')['agency_id']) && Session::get('family_session')['agency_id'] == $row->agency_id ? 'selected' : '' }}>
                          ...
                          <select class="form-control Family_id" name="Family_id" id="Family_id">
                              <option value="">--Select--</option>
                          </select>
                      </div> --}}
                            <div class="col-md-2 mb-3">
    ...
    <script>
        ...
        //                 if (data != '') {
        //                     $('#Family_id').html(data);
        //                     @php echo !empty($session_data["Family_id"]) && $session_data["Family_id"]>0 ? "$('#Family_id').val('".$session_data["Family_id"]."');" : "" @endphp
