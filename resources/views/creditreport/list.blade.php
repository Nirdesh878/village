        ...
        <div class="page-header">
            <div class="row align-items-end">
                <div class="col-lg-8">
                    ...
                    @php $session_data = Session::get('credit_filter_session'); @endphp
                    ...
                    <div class="export_icon_css">
                        <a href="{{ url('export_credreport') }}" id="export"> <img
                                src="{{ asset('assets\images\excel.png') }}" data-toggle="tooltip"
                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-block">
                                <form class="container" method="GET" action="{{ url('creditreport') }}"
                                    ...
                                    <table id="simpletable" class="table table-striped table-bordered nowrap"
                                        ...
                                        <thead class="back-color">
                                            ...
                                            <tr>
                                                ...
                                                {{-- <th>Total loan amount requested:</th>
                                    <th>Reviewed/verified by District manager/federation</th> --}}
                                            </tr>
                                        </thead>
                                        <tbody>
