                ...
                <div class="col-lg-8">
                    <div class="page-header-breadcrumb">
                        <ul class="breadcrumb-title">
                            ...
                            <li class="breadcrumb-item">Family Quality Assurance</li>
                        </ul>
                    </div>
                    <div style="clear: both"></div>
                    <div class="page-header-title">
                        <div class="d-inline">
                            <h4>Family Quality Assurance</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 text-right">
                    {{-- <a href="{{ url('/add_family_task') }}" class="btn cur-p btn-sm btn-success">Assign Task </a> --}}
                </div>
            </div>
        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 mb-3" style="margin-left: -40px;">
                                        ...
                                        <select class="form-control" name="group" id="group">
                                            ...
                                            <option value="FM" selected>Family</option>
