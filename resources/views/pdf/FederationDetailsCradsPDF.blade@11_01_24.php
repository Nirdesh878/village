                        ...
                        <table class="table table-bordered  new-table-dg">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Rich</td>
                                    < class="text-center">{{ (int) $inclusion[0]->no_of_rich != '' ? (int) $inclusion[0]->no_of_rich : 0 }}
                                    </>
                        ...
                        <table class="table table-bordered  new-table-dg">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td style="background: #ccc7c7; width:20%;">Date is was Established</td>
                        ...
                        <table class="table table-bordered  new-table-dg">
                            ...
                            <tbody class="text-center">
                                <tr>
                                    ...
                                    <td>{{ $sustainability[0]->cumulative_savings_voluntary }}</td>
                                    <td>{{ $sustainability[0]->cumulative_savings_other }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $sustainability[0]->amount_saved_voluntary }}</td>
                                    <td>{{ $sustainability[0]->amount_saved_other }}</td>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    @if ($risk_mitigation[0]->availed_members_covered_under_loan_insurance > 0)
                                        <td>{{ ($risk_mitigation[0]->par_availed_members_covered_under_loan_insurance * 100) / $risk_mitigation[0]->availed_members_covered_under_loan_insurance }}%
                                        </td>
                                    @else
                                        <td>0%</td>
                                    @endif
                        ...
                        <table class="table table-bordered  new-table-dg">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $observation[0]->federationObservationMeeting != '' ? $observation[0]->federationObservationMeeting : 0 }}
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $observation[0]->federationObservationCarriedOut != '' ? $observation[0]->federationObservationCarriedOut : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    <td style="text-align: center;">3</td>
                                    <td>What was quality of Discussion? Did everyone
                                        participate?</td>
                                    <td>{{ $observation[0]->federationObservationLeadersOnly != '' ? $observation[0]->federationObservationLeadersOnly : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>{{ $observation[0]->federationObservationNormsHave != '' ? $observation[0]->federationObservationNormsHave : 'N/A' }}
                                    </td>
                                </tr>
                                <tr>
