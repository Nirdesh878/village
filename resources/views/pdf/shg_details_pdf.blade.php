...
<body class="antialiased container mt-5">
   ...
   <br>
    ...
    <table class="table table-bordered table-stripped table1 " cellspacing="0">
        <thead>
            <tr class="table-primary" style="text-align: center;">
                <td style="background-color:black;color:white" >ANALYSIS</td>
            </tr>
        </thead>
    </table>
    <br>
    ...
    <table class="table table-bordered table-stripped table1 " cellspacing="0">
        <thead>
            <tr class="table-primary" >
                <td style="background-color:#01a9ac" colspan="5">Indicators & Score</td>
            </tr>
        </thead>
        <tbody>
            <tr>
                ...
                <th width="16%" class="tdc">Total Score per objective</th>
                <th width="16%" class="tdc">Score Obtained</th>
                <th width="16%" class="tdc">Risk Level </th>
            </tr>
            ...
            <tr>
                ...
                <td class="tdc">{{ $analysis_data['shg_book_updation'] }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">{{  $analysis_data['shg_grading_status']  }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">4</td>
                <td class="tdc">{{ $analysis_data['shg_percent_of_poorest_internal']  }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">4</td>
                <td class="tdc">{{ $analysis_data['shg_percent_of_poorest_other']   }}</td>
                <td>
                    {{-- <div class='status_analysis {{ $analysis_data['color16'] }} '>
                    </div> --}}
                    <div class="round" style="background:{{ $analysis_data['color16'] }} ;margin-left:45%; "></div>
                </td>
            </tr>
            <tr>
                <td >6</td>
                ...
                <td class="tdc">5</td>
                <td class="tdc">{{  $analysis_data['no_of_leadership_poor'] }}</td>
                <td>
                    {{-- <div class='status_analysis {{ (!empty($analysis_data['color66']) ? $analysis_data['color66'] : '') }} '>
                    </div> --}}
                    <div class="round" style="background:{{ (!empty($analysis_data['color66']) ? $analysis_data['color66'] : '') }} ;margin-left:45%; "></div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td class="tdc">5</td>
                <td class="tdc">{{   $analysis_data['shg_operational_cost']  }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">5</td>
                <td class="tdc">{{  $analysis_data['shg_time_taken_loan_disburse']   }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">12</td>
                {{-- <td class="tdc">{{$analysis_data['shg_repayment_internal']. '( ' .(str_replace('%','',$analysis[0]->shg_repayment_internal)). ' )'}}</td> --}}
                <td class="tdc">{{  $analysis_data['shg_repayment_internal']   }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">12</td>
                <td class="tdc">{{  $analysis_data['shg_repayment_other']  }}</td>
                <td>
            ...
            <tr>
                <td>11</td>
                <td>PAR status of all loans </td>
                <td class="tdc">6</td>
                <td class="tdc">{{  $analysis_data['shg_PAR_status_internal_loan']   }}</td>
                <td>
            ...
            <tr>
                <td>12</td>
                <td>PAR status of Other loans </td>
                <td class="tdc">6</td>
                <td class="tdc">{{  $analysis_data['shg_PAR_status_other_loan']   }}</td>
                <td>
                    {{-- <div class='status_analysis {{ $analysis_data['color19'] }} '>
                    </div> --}}
                    <div class="round" style="background:{{ $analysis_data['color19'] }} ;margin-left:45%; "></div>
            ...
            <tr>
                ...
                <td class="tdc">10</td>
                <td class="tdc">{{  $analysis_data['shg_regularity_savings']  }}</td>
                <td>
            ...
            <tr>
                ...
                <td class="tdc">5</td>
                <td class="tdc">{{  $analysis_data['shg_compulsory_savings']   }}</td>
                <td>
                    {{-- <div class='status_analysis {{ $analysis_data['color18'] }} '>
                    </div> --}}
                    <div class="round" style="background:{{ $analysis_data['color18'] }} ;margin-left:45%; "></div>
                </td>
            ...
            <tr>
                ...
                <td class="tdc">5</td>
                <td class="tdc">{{  $analysis_data['shg_voluntary_savings']  }}</td>
                <td>
                    {{-- <div class='status_analysis {{ $analysis_data['color81'] }} '>
                    </div> --}}
                    <div class="round" style="background:{{ $analysis_data['color81'] }} ;margin-left:45%; "></div>
            ...
            <tr>
                ...
                <th></th>
                <th class="tdc">100</th>
                <th class="tdc">{{  $grd_total  }}</th>
                <th>
                    {{-- <div class='status_analysis {{ $total_show }} '></div> --}}
                    <div class="round" style="background:{{ $total_show }} ;margin-left:45%; "></div>
