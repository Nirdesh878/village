...
<head>
    ...
    <title>SHG Development Card</title>
</head>
<style>
    .table1 {
        width: 100%;
...
<body>
    ...
    <div class="d-inline">
        <h3
            style="font-family: Arial, Helvetica, sans-serif;text-align:center;font-size:34px;color:rgba(7, 83, 146, 0.726);position: relative;top:-120px;">
            SHG INSTITUTIONAL DEVELOPMENT CARD
        </h3>
    </div>
    ...
    <table class="table table-bordered table-stripped table1 " cellspacing="0" style="margin-top: -120px;">
        ...
        <tbody>
            <tr>
                <th width="17%" style="text-align: left">Group Name:</th>
                <td width="16%" style="text-align: left">{{ $profile[0]->shgName }}</td>
                <td width="16%" style="text-align: left">UIN:</td>
                <td width="16%" style="text-align: left">{{ $shg->uin }}</td>
                <th width="16%" style="text-align: left">DATE:</th>
                <td width="26%" style="text-align: left">{{ change_date_month_name_char(str_replace('/', '-', $shg->created_at)) }}</td>
            </tr>
            ...
            <tr>
                ...
                <td width="26%">{{ checkna($profile[0]->name_of_state) }}</td>
            </tr>
            <tr>
                <th width="17%" style="text-align: left"> District:</th>
                <td width="16%">{{ checkna($profile[0]->name_of_district) }}</td>
                <td width="16%" style="text-align: left"> Village Name:</td>
                <td width="16%" style="text-align: left">{{ checkna($profile[0]->village) }}</td>
                <th width="16%" style="text-align: left">Block Name: </th>
                <td width="26%" style="text-align: left"></td>
            </tr>
    ...
    <div class="page-header-title" style="margin-top: -50px;">
        ...
        @php
            ...
            if ($grd_total >= 90) {
                $color = 'green';
            } elseif ($grd_total >= 75 && $grd_total <= 89) {
                $color = 'yellow';
            } elseif ($grd_total >= 75 && $grd_total <= 89) {
                $color = 'yellow';
            } elseif ($grd_total >= 60 && $grd_total <= 74) {
                $color = 'lightgrey';
            } elseif ($grd_total <= 59) {
                $color = 'red';
            }
    ...
    <div class="page-header-title">
        <div class="d-inline">
            <h3
                ...
                SHG GOALS, CHALLENGES & ACTION PLAN
            ...
            <div class="page-header-title">
                <div class="d-inline">
                    <h3 style="font-family: Arial, Helvetica, sans-serif;text-align:start;font-size:20px;"
                        style="margin:0px 0px">SHG Name:&nbsp; {{ $profile[0]->shgName }}
                    </h3>
                </div>
                <div class="d-inline" style="margin-left:700px;margin-top:-80px;">
                    <h3 style="font-family: Arial, Helvetica, sans-serif;text-align:start;font-size:20px;"
                        style="margin:0px 0px">UIN:&nbsp;{{ $shg->uin }}
                    </h3>
                </div>
            </div>
            ...
            <table style=" border-collapse: collapse;width:100%;">
                <tbody>
                    <tr>
                        ...
                        <th style="padding: 8px; text-align: left; border-bottom: 1px solid #ddd ">SHG
                            challenges</th>
                    </tr>
                    @php $i=1; @endphp
                    @if (!empty($challenges))
