...
<body class="antialiased container mt-5">
    ...
    <div class="page-header-title">
        <div class="d-inline">
            <h2 style="font-family: Arial, Helvetica, sans-serif;text-align:center;font-size:30px;"><u>Quality Wise Report - {{$name[0]->name}}</u>
            </h2>
        </div>
    ...
    <table class="table table-bordered table-stripped table1 " cellspacing="0">
        <thead>
            <tr class="table-primary" style="text-align: center;">
                <td style="background-color:#01a9ac" colspan="8">Quality Wise Report </td>
            </tr>
        </thead>
        <tbody id="simpletable">
            ...
            @php $i = 1; $task_type='_'; $task_a1='_'; $quality_status='_'; @endphp
