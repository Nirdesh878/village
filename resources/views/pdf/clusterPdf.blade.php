...
<body class="antialiased container mt-5">
    ...
    <div class="page-header-title">
        <div class="d-inline">
            <h2 style="font-family: Arial, Helvetica, sans-serif;text-align:center;font-size:30px;"><u>Cluster<u>
            </h2>
        </div>
    </div>
    <table class="table table-bordered table-stripped table1 " cellspacing="0" >
        <thead>
            <tr class="table-primary" style="text-align: center;">
                <td style="background-color:#01a9ac" colspan="16">Cluster</td>
            </tr>
            <tr>
                <th>S.No</th>
                <th>UIN</th>
        ...
        <tbody>
            ...
            @foreach ($data as $res)
                ...
                <tr>
                    ...
                    <td>{{ change_date_month_name_char(str_replace('/', '-', $res->cluster_formed)) }}</td>
