        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                <div class="export_icon_css" >
                    <a href="{{ url('credit_loan') }}" id="export">
                ...
                <div class="export_pdf_css" style="margin-top: ;  !important;">
                    <a href="{{ URL::to('/credit_loan_report') }}">
                            ...
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        ...
                                        {{!empty($loans[0]->loan_demand) ? '₹ '.$loans[0]->loan_demand : '₹ 0'}}
                                        </h2>
                                    </div>
                                </div>
                        ...
                        <div class="card l-bg-blue-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            {{!empty($loans[0]->loan_approved) ? '₹ '.$loans[0]->loan_approved : '₹ 0'}}
                        ...
                        <div class="card l-bg-green-dark">
                            <div class="card-statistic-3 p-4">
                                ...
                                <div class="row align-items-center mb-2 d-flex">
                                    <div class="col-8">
                                        <h2 class="d-flex align-items-center mb-0">
                                            {{!empty($loans[0]->loan_disbursed) ? '₹ '.$loans[0]->loan_disbursed : '₹ 0'}}
