            ...
            <div class="row align-items-end">
                ...
                <div class="col-lg-4">
                    <div class="export_icon_css" style="margin-top: -32px;">
                        <a href="{{ url('export_quality') }}" id="export">
                    ...
                    <div class="export_pdf_css" style="margin-top: -32px; right: 11% !important;">
                        <a href="{{ URL::to('/qualityWiseReportPdf') }}">
                ...
                <div class="modal-header-full-width   modal-header ">
                    ...
                    <div class="col-md-7 mb-4">
                        <div class=" export_pdf_css" style="position:relative;left:10%;top:15px;">
                            <a href="{{ URL::to('/qualityTaskAssignmentPdf') }}" id="abc">
    ...
    <script>
        $(function() {
            ...
            var table = $('#simpletable').DataTable({
                ...
                "responsive": false,
                "ajax": {
                    "url": '{{ route('QualityWiseReport.index') }}',
                    "type": "GET",
                    "dataType": "json",
            ...
            if (userID != '') {
                $.ajax({
                    ...
                    success: function(data) {
                        $('#taskTable').html(data);
                        $('#abc').attr('href', "{{ URL::to('/qualityTaskAssignmentPdf') }}?" + 'userID=' +
                            userID);
                    }
                });
            }
