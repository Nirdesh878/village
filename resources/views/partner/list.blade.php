    ...
    <div class="page-header">
        <div class="row align-items-end">
            ...
            <div class="export_icon_css" style="margin-top: -32px;">
                <a href="{{ url('partnerExport') }}" id="export">
            ...
            <div class="col-lg-4 text-right">
                    <a href="{{ url('partner/create') }}" class="btn cur-p btn-sm btn-success" >Create Partner
                    </a>
            </div>
        </div>
    </div>
        ...
        bootbox.confirm({
            ...
            callback: function (result) {
                if(result)
                {
                    ...
                    var url = '{{ route("partner.destroy", ":id") }}';
