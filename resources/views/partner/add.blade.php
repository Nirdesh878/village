                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <div class="mT-30">
                                <form class="container" method="POST" action="{{ route('partner.store') }}"
                                    autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="partners_name"
                                                value="{{ old('partners_name') }}" autocomplete="off"  required onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            ...
                                            <input type="text" class="form-control" name="contact_person"
                                                value="{{ old('contact_person') }}" autocomplete="off" required onkeypress="return (event.charCode > 64 && event.charCode < 91) || (event.charCode > 96 && event.charCode < 123) || (event.charCode==32)" />
                                    ...
                                    <div class="row">
                                        ...
                                        <input type="text" class="form-control number" name="contact_number"
                                                value="{{ old('contact_number') }}" autocomplete="off" required>
