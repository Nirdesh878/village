                        ...
                        <div class="login__form">
                            @if (session('success'))
                                <div class="alert alert-success" role="alert"
                                    style="
                                font-size: 19px;"> {{ session('success') }}
                                </div>
                            @endif
                            ...
                            @if (session('error'))
                                <div class="alert alert-danger" role="alert"
                                    style="
                                font-size: 19px;"> {{ session('error') }}
                                </div>
                            @endif


                            {{-- @php $user = Auth::user();  @endphp --}}
                            <form method="POST" action="{{ route('otp.getlogin') }}" autocomplete="off">
                                @csrf
                                @error('otp')
                            ...
                            {{-- <a href="{{ route('logout') }}" style="width:100%;" id="back">Back</a> --}}
                        </div>
                    </div>
                </div>
            </div>
