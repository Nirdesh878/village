                ...
                <div class="head-pannel s-box">
                    <div class="d-flex">
                        ...
                        <div class="headerfont">
                            <h2>{{ $profile[0]->name_of_federation }}</h2>
                        ...
                        <div class="ml-auto d-flex">
                            <!-- <div class="rating-box s-box mr-4" style="background-color:#f443368c;">
                                    <h4>NRLM CODE</h4>
                                    <h3>{{ $profile[0]->clf_code }}</h3>
                                    <p></p>
                                </div> -->
                            <div class="rating-box s-box mr-4 {{ $show_final_total }}">
                                <h4>Analytics and Rating</h4>
                                <h3>{{ $analysis_final_total }}</h3>
                                        ...
                                        <table class="table table-bordered mytable" colspan="2">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="{{ URL::to('/federationDetailsPdf/' . $federation_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                @endif
                                                <tr>
                                                    <th>Federation Profile with Report Card </th>
                                                    <td><a href="{{ URL::to('/federationDetailsCardPdf/' . $federation_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <th>Federation Report Card </th>
                                                    <td><a href="{{ URL::to('/federationcardPdf/' . $federation_ids) }}" class="btn iconbtn btn-success ml-2"><i class="las ti-download"></i></a></td>
                                                </tr>
                                        ...
                                        <div class="row alldetail">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">{{ $federation->uin }}</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $profile[0]->date_federation_was_found != ''? change_date_month_name_char(str_replace('/', '-', $profile[0]->date_federation_was_found)): 'N/A' }}
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $profile[0]->legal_status != '' ? $profile[0]->legal_status : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $profile[0]->registration_no != '' ? $profile[0]->registration_no : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table mytable">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ (int) $profile[0]->clusters_at_time_creation }}</td>
                                                    <td>{{ (int) $profile[0]->total_clusters }}</td>
                                                </tr>
                                                <tr>
                                                    <td>B</td>
                                                    <td>No of SHGs</td>
                                                    <td>{{ (int) $profile[0]->shg_at_time_creation }}</td>
                                                    <td>{{ (int) $profile[0]->total_SHGs }}</td>
                                                </tr>
                                                <tr>
                                                    <td>C</td>
                                                    <td>No of members</td>
                                                    <td>{{ (int) $profile[0]->members_at_time_creation }}</td>
                                                    <td>{{ (int) $profile[0]->total_members }}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                        ...
                                        <div class="row alldetail">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $profile[0]->Treasurer != '' ? $profile[0]->Treasurer : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6"><strong> Name</strong></div>
                                                    <div class="col-6">
                                                        {{ $profile[0]->book_keeper_name != '' ? $profile[0]->book_keeper_name : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Account
                                                            head</strong></div>
                                                    <div class="col-6">{{ $row->account_head }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Account
                                                            type</strong></div>
                                                    <div class="col-6">{{ $row->account_type }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $row->account_opening_date != ''? change_date_month_name_char(str_replace('/', '-', $row->account_opening_date)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Name of
                                                            Branch</strong></div>
                                                    <div class="col-6">{{ $row->branch }}</div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="row detail">
                                            ...
                                            <div class="col-md-6">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">{{ $row->account_ifsc }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ checkna($governance[0]->adoption_of_rules) }}
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Date of
                                                            Adoption</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->date_of_adoption != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_adoption)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            @endif
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->frequency_election != '' ? $governance[0]->frequency_election : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->frequency_as_per_norms != '' ? $governance[0]->frequency_as_per_norms : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->no_of_elections_conducted_so_far != ''? $governance[0]->no_of_elections_conducted_so_far: 0 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->date_of_last_election_option != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_last_election_option)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                ...
                                                <div class="row detail pl-2"><strong>1st :</strong><span style="margin-left: 8%;">{{ checkna($governance[0]->last_two_election_conducted) }}</span>
                                                </div>
                                                <div class="row detail pl-2"><strong>2nd :</strong><span style="margin-left: 8%;">{{ checkna($governance[0]->last_two_election_conducted_2nd) }}</span>
                                                </div>
                                                <div class="row detail pl-2"><strong>3rd :</strong><span style="margin-left: 8%;">{{ checkna($governance[0]->last_two_election_conducted_3rd) }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>No of meetings conducted during
                                                            ...
                                                            months</strong></div>
                                                    <div class="col-6">
                                                        {{ (int) $governance[0]->meetings_federation_last_six_months }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $governance[0]->participation_members_last_six_months }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ (int) $governance[0]->Total_board_members }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row alldetail">
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->who_writes_the_minutes != '' ? $governance[0]->who_writes_the_minutes : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="family-box mt-3">
                                    ...
                                    <div class="card-box">
                                        <div class="row alldetail">
                                            ...
                                            @if ($governance[0]->general_assembly == 'Yes')
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Frequency</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->frequency_assembly_meetings != '' ? $governance[0]->frequency_assembly_meetings : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>No of GA/GB
                                                            members</strong></div>
                                                    <div class="col-6">
                                                        {{ (int) $governance[0]->number_of_GA_members != '' ? (int) $governance[0]->number_of_GA_members : 0 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>No of meetings conducted
                                                            ...
                                                            months</strong></div>
                                                    <div class="col-6">
                                                        {{ (int) $governance[0]->federation_conducted_meetings != ''? (int) $governance[0]->federation_conducted_meetings: 0 }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Date of last
                                                            meeting</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->date_of_last_metting != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_last_metting)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->budget_approval_by_general_assembly != ''? $governance[0]->budget_approval_by_general_assembly: 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>Date of last plan and
                                                            ...
                                                            approval</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->date_of_last_budget_and_annual_approval != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_last_budget_and_annual_approval)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->member_aware != '' ? $governance[0]->member_aware : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6"><strong>i. Financial (Y/N), if yes
                                                            specify</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->Annual_plan_Financial }} -
                                                    ...
                                                    <div class="col-6"><strong>iv. Convergence (Y/N), if
                                                            ...
                                                            specify</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->Annual_plan_Convergence }}
                                                        -
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->Annual_plan_Others }} -
                                            ...
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    <div class="col-6"><strong>How often books
                                                            updated</strong></div>
                                                    <div class="col-6">
                                                        {{ $governance[0]->how_often_are_books_updated != '' ? $governance[0]->how_often_are_books_updated : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->date_of_last_updated_books != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_last_updated_books)): 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->updated_status != '' ? $governance[0]->updated_status : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        <strong>{{ $governance[0]->issues_highlighted_external_audit != ''? $governance[0]->issues_highlighted_external_audit: 'N/A' }}</strong>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row alldetail">
                                            <div class="col-md-6 table-padd">
                                                <div class="row detail">
                                                    ...
                                                    <div class="col-6">
                                                        {{ $governance[0]->grading_obtained != '' ? $governance[0]->grading_obtained : 'N/A' }}
                                                    </div>
                                                </div>
                                            </div>
                                            {{-- <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        <div class="col-12">
                                                            <strong>{{ $governance[0]->grading_obtained !='' ? $governance[0]->grading_obtained : 'N/A' }}</strong>
                                        </div>
                                    </div>
                                </div> --}}
                            </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->federation_social_audit_committee != ''? $governance[0]->federation_social_audit_committee: 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                @if ($governance[0]->federation_social_audit_committee == 'Yes')
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>SAC formation date</strong>
                                        </div>
                                        <div class="col-6">
                                            {{ $governance[0]->when_was_the_SAC_created != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->when_was_the_SAC_created)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Date of last report
                                                ...
                                                GB/GA</strong></div>
                                        <div class="col-6">
                                            {{ $governance[0]->date_last_report_submitted != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_last_report_submitted)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    ...
                                    <div class="row detail pl-2"><strong>1st -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->issues_highlighted1 }}
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail pl-2"><strong>2nd -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->issues_highlighted2 }}
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail pl-2"><strong>3rd -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->issues_highlighted3 }}
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail pl-2"><strong>4th -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->issues_highlighted4 }}
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail pl-2"><strong>5th -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->issues_highlighted5 }}
                                    </div>
                                    @endif
                                    @if ($blank == '')
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6"><strong>{{ $governance[0]->any_other_committee_formed != '' ? $governance[0]->any_other_committee_formed : 'N/A' }}</strong></div>
                                    </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    ...
                                    @if ($governance[0]->please_mention_names_of_committee != '')
                                    <div class="row detail pl-2"><strong>1st -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->please_mention_names_of_committee }}
                                    </div>
                                    @endif
                                    @if ($governance[0]->please_mention_names_of_committee2 != '')
                                    <div class="row detail pl-2"><strong>2nd -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->please_mention_names_of_committee2 }}
                                    </div>
                                    @endif
                                    @if ($governance[0]->please_mention_names_of_committee3 != '')
                                    <div class="row detail pl-2"><strong>3rd -
                                        </strong>&nbsp;&nbsp;{{ $governance[0]->please_mention_names_of_committee3 }}
                                    </div>
                                    @endif
                                </div>
                                @endif
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkna($governance[0]->internal_audit) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->frequency_internal_audit_conducted }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->date_of_last_internal_audit != ''? change_date_month_name_char(str_replace('/', '-', $governance[0]->date_of_last_internal_audit)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->Highlighted_issues_addressed }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->Issues_highlighted_by_internal_audit }}
                                        </div>
                                    </div>
                            ...
                            <div class="row alldetail">
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ Change_date_month_name_char(str_replace('/', '-', $governance[0]->date_external_audit_conducted)) }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>No of highlighted issues
                                                ...
                                                federation</strong></div>
                                        <div class="col-6">
                                            {{ $governance[0]->issues_highlighted_resolved }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Issues and observations
                                                ...
                                                last 12 months (Y/N)</strong></div>
                                        <div class="col-6">
                                            {{ $governance[0]->issues_highlighted_external_audit }}
                                        </div>
                                    </div>
                                    ...
                                    <div class="row detail pl-2">Other -
                                        {{ $governance[0]->issues_highlighted_external_audit_other }}
                                    </div>
                                    @endif
                                    @endif
                                </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ (int) $governance[0]->Total_SHGs_formed != '' ? (int) $governance[0]->Total_SHGs_formed : '0' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->present_no_of_SHGs_defunct != '' ? $governance[0]->present_no_of_SHGs_defunct : '0' }}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $governance[0]->Defunct_SHGs != '' ? $governance[0]->Defunct_SHGs : '0' }}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $inclusion[0]->wealth_ranking_mapping != '' ? $inclusion[0]->wealth_ranking_mapping : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                @if ($inclusion[0]->wealth_ranking_mapping == 'Yes')
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $inclusion[0]->month_year_of_1st_poverty_mapping != ''? change_date_month_name_char(str_replace('/', '-', $inclusion[0]->month_year_of_1st_poverty_mapping)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Date of last
                                                update</strong></div>
                                        <div class="col-6">
                                            {{ $inclusion[0]->month_year_of_last_update != ''? change_date_month_name_char(str_replace('/', '-', $inclusion[0]->month_year_of_last_update)): 'N/A' }}
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ (int) $inclusion[0]->no_of_poorest_and_most_vulnerable != ''? (int) $inclusion[0]->no_of_poorest_and_most_vulnerable: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_poorest_and_most_vulnerable_mobilised != ''? (int) $inclusion[0]->no_of_poorest_and_most_vulnerable_mobilised: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_poorest_and_most_vulnerable_hhm != ''? (int) $inclusion[0]->no_of_poorest_and_most_vulnerable_hhm: 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                    <td>Poor</td>
                                    <td>{{ (int) $inclusion[0]->no_of_poor_category != '' ? (int) $inclusion[0]->no_of_poor_category : 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_poor_category_mobilised != ''? (int) $inclusion[0]->no_of_poor_category_mobilised: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_poor_category_hhm != '' ? (int) $inclusion[0]->no_of_poor_category_hhm : 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>Medium poor</td>
                                    <td>{{ (int) $inclusion[0]->no_of_medium_poor != '' ? (int) $inclusion[0]->no_of_medium_poor : 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_medium_poor_mobilised != ''? (int) $inclusion[0]->no_of_medium_poor_mobilised: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_medium_poor_hhm != '' ? (int) $inclusion[0]->no_of_medium_poor_hhm : 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Rich</td>
                                    <td>{{ (int) $inclusion[0]->no_of_rich != '' ? (int) $inclusion[0]->no_of_rich : 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_rich_mobilised != '' ? (int) $inclusion[0]->no_of_rich_mobilised : 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->no_of_rich_hhm != '' ? (int) $inclusion[0]->no_of_rich_hhm : 0 }}
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Total</td>
                                    <td>{{ (int) $inclusion[0]->total_poverty_mapping_ineligible_mobilised != ''? (int) $inclusion[0]->total_poverty_mapping_ineligible_mobilised: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->total_poverty_mapping_mobilised_member != ''? (int) $inclusion[0]->total_poverty_mapping_mobilised_member: 0 }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->total_poverty_mapping_households != ''? (int) $inclusion[0]->total_poverty_mapping_households: 0 }}
                                    </td>
                                </tr>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ (int) $inclusion[0]->no_of_SC_and_ST }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                    ...
                    <div class="family-box mt-3">
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Very Poor &amp; vulnerable</td>
                                    <td>{{ (int) $inclusion[0]->federation_poorest_category_hhs }}</td>
                                ...
                                <tr>
                                    <td>Poor</td>
                                    <td>{{ (int) $inclusion[0]->federation_poor_category_hhs }}</td>
                                ...
                                <tr>
                                    <td>Medium</td>
                                    <td>{{ (int) $inclusion[0]->federation_medium_hhs }}</td>
                                ...
                                <tr>
                                    <td>Rich</td>
                                    <td>{{ (int) $inclusion[0]->federation_rich_hhs }}</td>
                                ...
                                <tr>
                                    <td>Total</td>
                                    <td>{{ (int) $inclusion[0]->federation_poorest_category_hhs +(int) $inclusion[0]->federation_poor_category_hhs +(int) $inclusion[0]->federation_medium_hhs +(int) $inclusion[0]->federation_rich_hhs }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->federation_poorest_category_recloan +(int) $inclusion[0]->federation_poor_category_recloan +(int) $inclusion[0]->federation_medium_recloan +(int) $inclusion[0]->federation_rich_recloan }}
                                    </td>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    <td>A</td>
                                    <td>Total Members</td>
                                    <td>{{ (int) $inclusion[0]->total_board_members_cluster }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $inclusion[0]->members_from_poorest_category }}</td>
                                    <td>{{ (int) $inclusion[0]->federation_inclusion_poor_members }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>No of members from the poor</td>
                                    <td>{{ (int) $inclusion[0]->members_from_poor_category }}</td>
                                    <td>{{ (int) $inclusion[0]->federation_inclusion_poor1_members }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>No of members from middle and rich category</td>
                                    <td>{{ (int) $inclusion[0]->members_from_middle_and_rich_category }}
                                    </td>
                                    <td>{{ (int) $inclusion[0]->federation_inclusion_rich_members }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <div class="card-box">
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    ...
                                    <div class="row detail">
                                        <div class="col-6">
                                            <strong>{{ $inclusion[0]->federation_social_goal_a }}</strong>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail">
                                        <div class="col-6">
                                            <strong>{{ $inclusion[0]->federation_social_goal_b }}</strong>
                                        </div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="row detail">
                                        <div class="col-6">
                                            <strong>{{ $inclusion[0]->federation_social_goal_c }}</strong>
                                        </div>
                                    </div>
                                    @endif
                                </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Has Federation Prepared
                                                ...
                                                plan (Y/N)</strong></div>
                                        <div class="col-6">
                                            {{ checkna($efficiency[0]->integrated_Federation_plan) }}
                                        </div>
                                    </div>
                                </div>
                                @if ($efficiency[0]->integrated_Federation_plan == 'Yes')
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Date of last plan approved
                                                ...
                                                Federation</strong></div>
                                        <div class="col-6">
                                            {{ $efficiency[0]->date_federation_plan_approved != ''? change_date_month_name_char(str_replace('/', '-', $efficiency[0]->date_federation_plan_approved)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $efficiency[0]->date_federation_plan_submitted != ''? change_date_month_name_char(str_replace('/', '-', $efficiency[0]->date_federation_plan_submitted)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ (int) $efficiency[0]->time_taken_to_approve_loan }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Average Monthly loans during
                                                ...
                                                months</strong></div>
                                        <div class="col-6">
                                            {{ (int) $efficiency[0]->loans_per_month_approved }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ (int) $efficiency[0]->time_taken_to_give_money_from_approval }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $efficiency[0]->cost_ratio_per_active_client != '' ? $efficiency[0]->cost_ratio_per_active_client : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Average operating
                                                expense</strong></div>
                                        <div class="col-6">
                                            {{ $efficiency[0]->operating_expenes != '' ? $efficiency[0]->operating_expenes : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $efficiency[0]->average_no != '' ? $efficiency[0]->average_no : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Operation Expense
                                                Ratio</strong></div>
                                        <div class="col-6">
                                            {{ $efficiency[0]->federation_operation_expense_ratio != ''? $efficiency[0]->federation_operation_expense_ratio: 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Average operating
                                                expense</strong></div>
                                        <div class="col-6">
                                            {{ $efficiency[0]->operation_expense != '' ? $efficiency[0]->operation_expense : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $efficiency[0]->avg_gross_portfolio != '' ? $efficiency[0]->avg_gross_portfolio : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Last 12 Months</td>
                                    <td>{{ $efficiency[0]->outstanding_loan_ratio_year1 != ''? (float) $efficiency[0]->outstanding_loan_ratio_year1: 0 }}
                                    </td>
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>1 Year before last year</td>
                                    <td>{{ $efficiency[0]->outstanding_loan_ratio_year2 != ''? (float) $efficiency[0]->outstanding_loan_ratio_year2: 0 }}
                                    </td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>2 years before last year</td>
                                    <td>{{ $efficiency[0]->outstanding_loan_ratio_year3 != ''? (float) $efficiency[0]->outstanding_loan_ratio_year3: 0 }}
                                    </td>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkna($efficiency[0]->integrated_credit_plan_approved) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            ...
                                            {{ $efficiency[0]->date_last_report_submitted != ''? change_date_month_name_char(str_replace('/', '-', $efficiency[0]->date_last_report_submitted)): 'N/A' }}
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->no_of_loans_approved }}</td>
                                </tr>
                                <tr>
                                    <td>3</td>
                                    <td>Pending loan applications</td>
                                    <td>{{ (int) $credithistory[0]->pending_loan_applications }}</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>No of Loans Approved within 15 days</td>
                                    <td>{{ (int) $credithistory[0]->no_of_loans_approved_within_15_days }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>5</td>
                                    <td>No of loans approved within 16 to 30 days</td>
                                    <td>{{ (int) $credithistory[0]->no_of_loans_sanctioned_within_15_days }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>6</td>
                                    <td>No of loans approved in more than 30 days</td>
                                    <td>{{ (int) $credithistory[0]->no_of_loans_sanctioned_between_1_3_months }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    <td>1</td>
                                    <td>Federation</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_amount_federation_loan }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>2</td>
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>VI</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_amount_vi_loan }}</td>
                                </tr>
                                <tr>
                                    <td>4</td>
                                    <td>Other</td>
                    ...
                    <div class="family-box mt-3">
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>Last 12 months</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_bank_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_bank_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_bank_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_bank_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_bank_loan_year1 }}
                                    </td>
                                </tr>

                                <tr>
                                    <td>Year before last</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_bank_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_bank_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_bank_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_bank_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_bank_loan_year2 }}
                                    </td>
                                </tr>

                                <tr>
                                    <td>2 Years before last</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_bank_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_bank_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_bank_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_bank_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_bank_loan_year3 }}
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>Last 12 months</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_VI_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_VI_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_VI_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_VI_loan_year1 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_VI_loan_year1 }}
                                    </td>
                                </tr>

                                <tr>
                                    <td>Year before last</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_VI_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_VI_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_VI_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_VI_loan_year2 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_VI_loan_year2 }}
                                    </td>
                                </tr>

                                <tr>
                                    <td>2 Years before last</td>
                                    <td>{{ (int) $credithistory[0]->federation_poorest_members_not_received_VI_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_poor_members_not_received_VI_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_medium_members_not_received_VI_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_rich_members_not_received_VI_loan_year3 }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->federation_total_members_not_received_VI_loan_year3 }}
                                    </td>
                                </tr>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ (int) $credithistory[0]->members_have_taken_more_than_one_loan }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table mytable table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->vi_loan_active }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->vi_loan_amount }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->dcb_vi }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->repaid_vi }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->overdue_amount_vi }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->loan_outstanding_vi }}</td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ Checkper((float) $credithistory[0]->repayment_rate_bank_loans) . '%' }}
                                    </td>
                                    <td>{{ Checkper((float) $credithistory[0]->repayment_rate_vi_loans) . '%' }}
                                    </td>
                                    <td>{{ Checkper((float) $credithistory[0]->repayment_rate_other_loans) . '%' }}
                                    </td>
                                    @php
                                    $num = 0;
                                    $e = 0;
                                    ...
                                    @endphp
                                    <td>{{ $e . '%' }}</td>
                                    {{-- <td>{{ ($credithistory[0]->repayment_rate_federation_loans + $credithistory[0]->repayment_rate_bank_loans + $credithistory[0]->repayment_rate_vi_loans +$credithistory[0]->repayment_rate_other_loans)/4 }}</td> --}}
                                </tr>
                            </tbody>
                        </table>
                    </div>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ (int) $credithistory[0]->loan_default_federation_members }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->default_federation_no_of_loans }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                ...
                                <tr>
                                    <td>C</td>
                                    <td>VI Loans</td>
                                    <td>{{ (int) $credithistory[0]->loan_default_vi_members }}</td>
                                    <td>{{ (int) $credithistory[0]->default_vi_no_of_loans }}</td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Other Loans</td>
                        ...
                        <table class="table mytable table-responsive">
                            ...
                            <tbody>
                                <tr>
                                    <td>A</td>
                                    <td>Federation loans</td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_1_months_Federation }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_2_months_Federation }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_3_months_Federation }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                    <td>Bank Loans</td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_1_months_Bank }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_2_months_Bank }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_3_months_Bank }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>VI Loans</td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_1_months_VI }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_2_months_VI }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_3_months_VI }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Other Loans</td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_1_months_other }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_2_months_other }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->overdue_More_than_3_months_other }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        ...
                        <table class="table mytable table-responsive">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>B</td>
                                    <td>Bank Loans</td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_30_days_Bank) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_60_days_Bank) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_90_days_Bank) }}
                                    </td>
                                ...
                                <tr>
                                    <td>C</td>
                                    <td>VI Loans</td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_30_days_VI) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_60_days_VI) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_90_days_VI) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Other Loans</td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_30_days_other) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_60_days_other) }}
                                    </td>
                                    <td>{{ Checkper($credithistory[0]->percentage_More_than_90_days_other) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $credithistory[0]->does_Federation_loan_tracking_system != ''? $credithistory[0]->does_Federation_loan_tracking_system: 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                @if ($credithistory[0]->does_Federation_loan_tracking_system == 'Yes')
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $credithistory[0]->when_was_it_established != ''? change_date_month_name_char(str_replace('/', '-', $credithistory[0]->when_was_it_established)): 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>What is the frequency of
                                                ...
                                                tracking</strong></div>
                                        <div class="col-6">
                                            {{ $credithistory[0]->frequency_of_loan_tracking }}
                                        </div>
                                    </div>
                                </div>
                                @endif
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>F</td>
                                    <td>Other</td>
                                    <td>{{ (int) $credithistory[0]->Other }}</td>
                                    <td>{{ (int) $credithistory[0]->Other_amount }}</td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td>Total</td>
                                    <td>{{ (int) $credithistory[0]->productive +(int) $credithistory[0]->consumption +(int) $credithistory[0]->debt_swapping +(int) $credithistory[0]->education +(int) $credithistory[0]->health +(int) $credithistory[0]->Other }}
                                    </td>
                                    <td>{{ (int) $credithistory[0]->productive_amount +(int) $credithistory[0]->consumption_amount +(int) $credithistory[0]->debt_swapping_amount +(int) $credithistory[0]->education_amount +(int) $credithistory[0]->health_amount +(int) $credithistory[0]->Other_amount }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($credithistory[0]->average_loan) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($credithistory[0]->average_loan_amount) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($credithistory[0]->maximum_amount) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($credithistory[0]->minimum_amount) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    <td>A</td>
                                    <td>Federation</td>
                                    <td>{{ checkna($credithistory[0]->declining_or_flat) }}</td>
                                    <td>{{ checkzero($credithistory[0]->percent_charged) }}</td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                    <td>Bank</td>
                                    <td>{{ checkna($credithistory[0]->declining_or_flat_bank) }}</td>
                                    <td>{{ checkzero($credithistory[0]->percent_charged_bank) }}</td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>VI</td>
                                    <td>{{ checkna($credithistory[0]->declining_or_flat_vi) }}</td>
                                    <td>{{ checkzero($credithistory[0]->percent_charged_vi) }}</td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Other</td>
                                    <td>{{ checkna($credithistory[0]->declining_or_flat_other) }}</td>
                                    <td>{{ checkzero($credithistory[0]->percent_charged_other) }}</td>
                                </tr>
                                {{-- <tr>
                                        <td></td>
                                        <td></td>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    <td>A</td>
                                    <td>Federation</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_interest_federation_loans }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                    <td>Bank</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_interest_bank_loans }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>VI</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_interest_vi_loans }}</td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Other Loans</td>
                                    <td>{{ (int) $credithistory[0]->cumulative_interest_other_loans }}
                                    </td>
                                </tr>
                                <tr>
                                    <td></td>
                    ...
                    <div class="family-box mt-3">
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>1</td>
                                    <td>{{ $credithistory[0]->actions_previous_year_defaults_a }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td>2</td>
                                    <td>{{ $credithistory[0]->actions_previous_year_defaults_b }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td>3</td>
                                    <td>{{ $credithistory[0]->actions_previous_year_defaults_c }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td>4</td>
                                    <td>{{ $credithistory[0]->actions_previous_year_defaults_d }}
                                    </td>
                                </tr>
                                @endif
                                ...
                                <tr>
                                    <td>5</td>
                                    <td>{{ $credithistory[0]->actions_previous_year_defaults_e }}
                                    </td>
                                </tr>
                                @endif
                            </tbody>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ checkzero($credithistory[0]->Total_corpus_fund_received) }}
                                    </td>
                                    <td>{{ checkzero($credithistory[0]->Total_corpus_fund_received_vi) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>B</td>
                                    <td>Total federation loan disbursed (Rs)</td>
                                    <td>{{ checkzero($credithistory[0]->Total_loan_given) }}</td>
                                    <td>{{ checkzero($credithistory[0]->Total_loan_given_vi) }}</td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>No of years completed since receipt of funds (#)</td>
                                    <td>{{ checkzero($credithistory[0]->completed_received_corpus_fund) }}
                                    </td>
                                    <td>{{ checkzero($credithistory[0]->completed_received_corpus_fund_vi) }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Yearly rotation Ratio</td>
                                    <td>{{ checkzero($credithistory[0]->Yearly_rotation_ratio) }}</td>
                                    <td>{{ checkzero($credithistory[0]->Yearly_rotation_ratio_vi) }}
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                ...
                <div class="tab-pane fade" id="v-pills-sustainability" role="tabpane" aria-labelledby="v-pills-sustainability-tab">
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($sustainability[0]->total_income_of_the_federation) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ checkzero($sustainability[0]->expense_of_the_federation) }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Coverage of Operational costs
                                                (Y/N)</strong></div>
                                        <div class="col-6">
                                            {{ checkzero($sustainability[0]->federation_covering_operational_cost) }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="family-box mt-3">
                        ...
                        <table class="table mytable">
                                    ...
                                    <div class="row alldetail">
                                        <div class="col-md-6 table-padd">
                                            <div class="row detail">
                                                ...
                                                <div class="col-6">
                                                    {{ checkna($sustainability[0]->have_loan_security_fund) }}
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <tbody>
                                @if ($sustainability[0]->have_loan_security_fund == 'Yes')
                                <tr>
                                    <td>A</td>
                                    <td>Whether LSF is in operation</td>
                                    <td>{{ $sustainability[0]->have_loan_security_fund }}</td>
                                </tr>

                                <tr>
                                    <td>B</td>
                                    <td>Date established/Verified</td>
                                    <td>{{ $sustainability[0]->date_it_was_established !='' ? change_date_month_name_char(str_replace('/', '-', $sustainability[0]->date_it_was_established )) : 'N/A'  }}</td>
                                </tr>
                                <tr>
                                    <td>C</td>
                                    <td>No of members contribute to LSF</td>
                                    <td>{{ $sustainability[0]->members_contribute_LSF }}</td>
                                </tr>
                                <tr>
                                    <td>D</td>
                                    <td>Amount available in LSF</td>
                                    <td>{{ $sustainability[0]->amount_available_security_fund }}
                                    </td>
                                </tr>
                                <tr>
                                    <td>E</td>
                                    <td>No of members benefitted from LSF</td>
                                    <td>{{ $sustainability[0]->members_benefited_by_LSF }}</td>
                                </tr>
                                @endif
                                @if ($sustainability[0]->have_loan_security_fund == 'No')
                                <tr>
                                    <td></td>
                                    <td>Reason member do not contribute</td>
                                    <td>{{ $sustainability[0]->reason_members_do_not_contribute }}
                                    </td>
                                </tr>
                                @endif
                            </tbody>
                        ...
                        <table class="table mytable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>{{ $sustainability[0]->cumulative_savings_voluntary != ''? $sustainability[0]->cumulative_savings_voluntary: 0 }}
                                    </td>
                                    <td>{{ $sustainability[0]->cumulative_savings_other != '' ? $sustainability[0]->cumulative_savings_other : 0 }}
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>{{ checkzero($sustainability[0]->amount_saved_voluntary) }}</td>
                                    <td>{{ checkzero($sustainability[0]->amount_saved_other) }}</td>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Other services Provided by
                                                Federation</strong></div>
                                        <div class="col-6">
                                            {{ $sustainability[0]->provide_any_other_Service != '' ? $sustainability[0]->provide_any_other_Service : 'N/A' }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        @if ($sustainability[0]->provide_any_other_Service == 'Yes')
                        <table class="table mytable">
                            <thead class="back-color">
                                <tr>
                                    <th>SN.</th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $row->date != '' ? change_date_month_name_char(str_replace('/', '-', $row->date)) : 'N/A' }}
                                    </td>
                                    <td>{{ $row->members }}</td>
                                </tr>
                                @endforeach
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            <strong>{{ $risk_mitigation[0]->total_general_assembly_members != ''? $risk_mitigation[0]->total_general_assembly_members: 0 }}</strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>No of members
                                                covered</strong></div>
                                        <div class="col-6">
                                            {{ (float) $risk_mitigation[0]->members_covered_under_life_insurance != ''? (float) $risk_mitigation[0]->members_covered_under_life_insurance: 0 }}
                                        </div>
                                    </div>
                                </div>
                                @php
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            ...
                                            {{ $risk_mitigation[0]->par_covered_under_life_insurance }}%
                                        </div>
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->availed_members_covered_under_loan_insurance != ''? $risk_mitigation[0]->availed_members_covered_under_loan_insurance: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>No of active borrowers
                                                covered</strong></div>
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->par_availed_members_covered_under_loan_insurance != ''? $risk_mitigation[0]->par_availed_members_covered_under_loan_insurance: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ round(($risk_mitigation[0]->par_availed_members_covered_under_loan_insurance * 100) /$risk_mitigation[0]->availed_members_covered_under_loan_insurance) }}%
                                        </div>
                                        @else
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->animal_purchased_during_last_one_year != ''? $risk_mitigation[0]->animal_purchased_during_last_one_year: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->animal_insured_last_one_year != ''? $risk_mitigation[0]->animal_insured_last_one_year: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                            ...
                            <div class="row alldetail">
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->No_of_claim_received != '' ? $risk_mitigation[0]->No_of_claim_received : 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        <div class="col-6"><strong>Total Claim amount
                                                (Rs)</strong></div>
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->Total_claim_amount_requested != ''? $risk_mitigation[0]->Total_claim_amount_requested: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->No_of_person_claim_setteled != ''? $risk_mitigation[0]->No_of_person_claim_setteled: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->Total_claim_amount_setteled != ''? $risk_mitigation[0]->Total_claim_amount_setteled: 0 }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 table-padd">
                                ...
                                <div class="col-md-6 table-padd">
                                    <div class="row detail">
                                        ...
                                        <div class="col-6">
                                            {{ $risk_mitigation[0]->settlement_claimed_insurance_per !='' ? $risk_mitigation[0]->settlement_claimed_insurance_per : '0%'  }}
                                        </div>
                                ...
                                {{-- <div class="col-md-6 table-padd">
                                                    <div class="row detail">
                                                        <div class="col-6"><strong>Settlement done (%)</strong>
                                                        </div>
                                                        @if (!empty($risk_mitigation[0]->Total_claim_amount_requested))
                                                            <div class="col-6">
                                                                {{ ((float) $risk_mitigation[0]->Total_claim_amount_setteled * 100) / (float) $risk_mitigation[0]->Total_claim_amount_requested }}%
                            </div>
                            @else
                            <div class="col-6">0</div>
                            @endif
                ...
                <div class="row alldetail">
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            <div class="col-6"><strong>No of animal death claims
                                    submitted</strong></div>
                            <div class="col-6">
                                {{ (int) $risk_mitigation[0]->death_claim_requested }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            <div class="col-6"><strong>Total amount of Claims
                                    ...
                                    (Rs)</strong></div>
                            <div class="col-6">
                                {{ (int) $risk_mitigation[0]->Total_claim_amount_requested_animal_death }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            ...
                            <div class="col-6">
                                {{ (int) $risk_mitigation[0]->animal_claim_setteled }}
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            ...
                            <div class="col-6">
                                {{ (int) $risk_mitigation[0]->Total_claim_amount_setteled_for_animal_death }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            ...
                            <div class="col-6">
                                {{ $risk_mitigation[0]->settlement_asset_insurance_no !='' ? $risk_mitigation[0]->settlement_asset_insurance_no : 0  }}
                            </div>
                    ...
                    <div class="col-md-6 table-padd">
                        <div class="row detail">
                            ...
                            <div class="col-6">
                                ...
                                {{ $risk_mitigation[0]->settlement_asset_insurance_per !='' ? $risk_mitigation[0]->settlement_asset_insurance_per : '0%'  }}
                            </div>
            ...
            <table class="table mytable table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_2 }}</td>
                        <td>
                            <div class='status_analysis {{ $show2 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>3</td>
                        ...
                        <td>{{ $analysis_3 }}</td>
                        <td>
                            <div class='status_analysis {{ $show3 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>4</td>
                        ...
                        <td>{{ $analysis_4 }}</td>
                        <td>
                            <div class='status_analysis {{ $show4 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>5</td>
                    ...
                    {{-- <tr>
                                                    <td>6</td>
                                                    <td></td>
                                                    <td>Federation Grade during last 12 months</td>
                                                    <td>3</td>
                                                    <td>{{ $analysis_6 }}</td>
                    <td>
                        <div class='status_analysis {{ $show6 }} '></div>
                    </td>
                    </tr> --}}
                    <tr>
                        <td>6</td>
                        ...
                        <td>{{ $analysis_7 }}</td>
                        <td>
                            <div class='status_analysis {{ $show7 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>7</td>
                        ...
                        <td>{{ $analysis_8 }}</td>
                        <td>
                            <div class='status_analysis {{ $show8 }} '></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_9 }}</td>
                        <td>
                            <div class='status_analysis {{ $show9 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>9</td>
                        ...
                        <td>{{ $analysis_10 }}</td>
                        <td>
                            <div class='status_analysis {{ $show10 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>10</td>
                        ...
                        <td>{{ $analysis_11 }}</td>
                        <td>
                            <div class='status_analysis {{ $show11 }} '></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_12 }}</td>
                        <td>
                            <div class='status_analysis {{ $show12 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>12</td>
                        ...
                        <td>{{ $analysis_13 }}</td>
                        <td>
                            <div class='status_analysis {{ $show13 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>13</td>
                        ...
                        <td>{{ $analysis_26 }}</td>
                        <td>
                            <div class='status_analysis {{ $show25 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>14</td>
                        ...
                        <td>{{ $analysis_14 }}</td>
                        <td>
                            <div class='status_analysis {{ $show14 }} '></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_15 }}</td>
                        <td>
                            <div class='status_analysis {{ $show15 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>16</td>
                        <td></td>
                        {{-- <td>Repayment rate of federation loan %</td> --}}
                        <td>Repayment rate of all loans (federation/bank/VI &others) during during last 12 months</td>
                        <td>10</td>
                        <td>{{ $analysis_16 }}</td>
                        <td>
                            <div class='status_analysis {{ $show16 }} '></div>
                        </td>
                    </tr>
                    {{-- <tr>
                                                    <td>17</td>
                    ...
                    @if ($analysis_17 != 'N/A')
                    <td>
                        <div class='status_analysis {{ $show17 }} '></div>
                    </td>
                    @else
                    <td>--</td>
                    @endif
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_18 }}</td>
                        <td>
                            <div class='status_analysis {{ $show18 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>18</td>
                        ...
                        <td>{{ $analysis_19 }}</td>
                        <td>
                            <div class='status_analysis {{ $show19 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>19</td>
                        ...
                        <td>{{ $analysis_20 }}</td>
                        <td>
                            <div class='status_analysis {{ $show20 }} '></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_21 }}</td>
                        <td>
                            <div class='status_analysis {{ $show21 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>21</td>
                        ...
                        <td>{{ $analysis_22 }}</td>
                        <td>
                            <div class='status_analysis {{ $show22 }} '></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>{{ $analysis_23 }}</td>
                        <td>
                            <div class='status_analysis {{ $show23 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>23</td>
                        ...
                        <td>{{ $analysis_24 }}</td>
                        <td>
                            <div class='status_analysis {{ $show24 }} '></div>
                        </td>
                    </tr>
                    <tr>
                        <td>24</td>
                    ...
                    <tr>
                        ...
                        <td></td>
                        <td>100</td>
                        <td>{{ $analysis_final_total }}</td>
                        <td>
                            <div class='status_analysis {{ $show_final_total }} '></div>
                        </td>
                    </tr>
                </tbody>
            </table>
        ...
        <div class="family-box mt-3">
            ...
            <table class="table mytable">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>Answer</td>
                        <td>{{ checkna($observation[0]->federation_understand_benefits_of_being_part)}}</td>
                    </tr>
                    <tr>
                        <td>5</td>
                    ...
                    <tr>
                        <td>A.</td>
                        <td>{{ checkna($observation[0]->federationObserHighlightsA) }}
                        </td>
                    </tr>
                    @endif
                    ...
                    <table class="table mytable">
                        ...
                        <tbody>
                            ...
                            <tr class="text-center">
                                <th><img src="/assets/uploads/{{ $image_first_year->imagename }}" height="100" width="100"></th>
                            </tr>
                            @endif
                            @endforeach
                        </tbody>
            ...
            <div class="card-box">
                <table class="table table-bordered mytable" colspan="2">
                    ...
                    <tbody>
                        <tr>
                            <th width="50%">Name</th>
                            <td width="50%">{{ $profile[0]->name_of_federation }}</td>
                        </tr>
                        <tr>
                            <th width="50%">UIN</th>
                            <td width="50%">{{ $federation->uin }}</td>
                        </tr>
                        <tr>
                            <th width="50%">State Name</th>
                            <td width="50%">{{ $profile[0]->name_of_state }}</td>
                        </tr>
                        ...
                        <tr>
                            <th>Date</th>
                            <td>{{ change_date_month_name_char(str_replace('/', '-', $federation->created_at)) }}
                            </td>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score >= 75 && $score <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score >= 60 && $score <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td width="10px" style="text-align: center">{{ $total_1to8 }}
                            </td>
                        ...
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score1 >= 75 && $score1 <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score1 >= 60 && $score1 <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score1 <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="text-align: center">{{ $total_9to11 }}</td>
                        ...
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score2 >= 75 && $score2 <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score2 >= 60 && $score2 <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score2 <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="text-align: center">{{ $total_12to14 }}</td>
                            <td style="text-align: center">15</td>
                            {{-- <td>{{round($score2)}}</td> --}}
                        </tr>
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score3 >= 75 && $score3 <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score3 >= 60 && $score3 <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score3 <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="text-align: center">{{ $total_15to20 }}</td>
                        ...
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score4 >= 75 && $score4 <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score4 >= 60 && $score4 <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score4 <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="text-align: center">{{ $total_21to22 }}</td>
                        ...
                        <tr>
                            ...
                            <td style="background-color: yellow;width:50px;">
                                @if ($score5 >= 75 && $score5 <= 89) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: lightgrey;width:50px;">
                                @if ($score5 >= 60 && $score5 <= 74) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="background-color: red;width:50px;">
                                @if ($score5 <= 59) <i class="c-black-500 ti-check" style="font-size:25px;font-weight:bold;"></i>
                                    @endif
                            </td>
                            <td style="text-align: center">{{ $total_23to25 }}</td>
        ...
        <div class="family-box mt-3">
            ...
            <div class="card-box">
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="col-md-8">
                            ...
                            <select class="form-control" name="TaskQaAssignment_status" id="TaskQaAssignment_status">
                ...
                <div class="col-sm-8 text-center">
                    ...
                    <input type="hidden" name="facilitator" id="facilitator" value="{{ $user_id }}">
                    <input type="hidden" name="dm_id" id="dm_id" value="{{ $dm_id }}">
                    <input type="hidden" name="task" id="task">
                    @if ($qa_status == 'P' || $quality_status == 'R')
                    <button type="button" id="save" class="btn btn-sm btn-success " onclick="return submitAction()">Save</button>
                    @endif
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 mb-3">
                        <div class="col-md-8">
                            ...
                            <select class="form-control" name="TaskQaAssignment_status1" id="TaskQaAssignment_status1" {{ $qa_readonly1 }}>
                                <option value="V">Verify</option>
                                <option value="R">Reject</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-12 mb-3">
                        <div class="col-md-8" id="remark_txt11">
                            ...
                            <textarea class="form-control form-control-sm" name="TTaskQaAssignment_remark1" id="TaskQaAssignment_remark1" {{ $qa_readonly1 }}></textarea>
                        </div>
                    </div>
                </div>
                <div class="col-sm-8 text-center">
                    <input type="hidden" name="task_id" id="task_id1" value="{{ $task_id }}">
                    <input type="hidden" name="agency_id" id="agency_id1" value="{{ $agency_id }}">
                    <input type="hidden" name="facilitator" id="facilitator1" value="{{ $user_id }}">
                    <input type="hidden" name="task" id="task">
                    @if ($quality_status == 'P')
                    <button type="button" id="save1" class="btn btn-sm btn-success " onclick="return submitAction1()">Save</button>
                    @endif
                </div>
            </div>
            @endif
                ...
                <table class="table mytable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><a data-toggle="modal" data-id="{{ $res->id }}" href="#remarks_m" data-type="M" class="btn btn-success btn-link btn-sm" data-target="#remarks_m"><i class="c-white-500 ti-eye"></i></a>
                            </td>
                            <td><a data-toggle="modal" data-id="{{ $res->id }}" href="#remarks_q" data-type="QA" class="btn btn-success btn-link btn-sm" data-target="#remarks_q"><i class="c-white-500 ti-eye"></i></a>
                            </td>
            ...
            callback: function(result) {
                if (result) {
                    ...
                    $.ajax({
                        ...
                        //     rmk + '&assignment_type="FD"&user_id=' + user_id,
                        //data: '_token = <?php echo csrf_token(); ?>&id=' + id + '&sts=' + sts + '&rmk=' + rmk + '&assignment_type="FD"&qrmk=' +qrmk,
                        data: {
    ...
    $(document).ready(function() {
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                labels: ["Rating", ""],
                datasets: [{
                    data: ['{{ $analysis_final_total }}',
                        '{{ 100 - $analysis_final_total }}'
                    ],
