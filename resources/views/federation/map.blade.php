    ...
    <div class="page-header">
        <div class="row align-items-end">
            <div class="col-lg-8">
                ...
                @php $session_data = Session::get('federation_session'); @endphp

                <div style="clear: both"></div>
                <div class="page-header-title">
                    <div class="d-inline"> 
                        <h4>Federation MAP</h4>
                    </div>
        ...
        <div class="card"> 
          <div class="card-block pt-2 pb-2">
              <div class="mT-30"> 
                  ...
                  <form class="" method="post" action="{{ url('getLatLongFederation')}}">
                      @csrf
                      <div class="row"> 
                          ...
                          <select class="form-control agency_id" name="agency_id" id="agency_id">
                              ...
                              @foreach ($agency as $row)
                                  <option value="{{ $row->agency_id }}"
                                    {{(!empty(Session::get('federation_session')['agency_id'])&& ((Session::get('federation_session')['agency_id']) == $row->agency_id ) ? "selected":"")}}>
                        ...
                        {{-- <div class="col-md-2 mb-3">
                          ...
                          <select class="form-control federation_id" name="federation_id" id="federation_id">
                              <option value="">--Select--</option>
                          </select>
                        </div> --}}
...
<script> 
 ...
 var childCount = cluster.getChildCount();
  ...
  var constant = $.map( get_data, function( e ) {
    ...
    markers.addLayer(L.marker([e.latitude,e.longitude],{icon : greenIcon}).addTo(markers).bindPopup("<div class='popup_div'><div class='row'><table class='table table-striped'>"+"<tr><td><b>Federation</b></td><td>"+e.name_of_federation+"</td></tr>"+"<tr><td><b>Latitude</b></td><td>"+e.latitude+"</td></tr>"+"<tr><td><b>Longitude</b></td><td>"+e.longitude+"</td></tr>"+"<tr><td><b>Location Name</b></td><td>"+e.location_name+"</td></tr>"+"<tr><td><b>Agency</b></td><td>"+e.agency_name+"</td></tr>" + "<tr><td><b>Date</b></td><td>" + e.lat_long_date_time + "</td></tr>" + "</table></div></div>")); 
  }); 
  markers.addTo(map); 
