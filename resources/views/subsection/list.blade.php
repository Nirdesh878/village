...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        @php $session_data = Session::get('sub_section_filters'); @endphp
                ...
                <div class="col-sm-12">
                    ...
                    <div class="card">
                        <div class="card-block">
                            <form class="container" method="GET" action="{{ url('subsection') }}" id="needs-validation"
                                autocomplete="off">
                                @csrf
                                <div class="row">
