...
use App\Http\Controllers\AppLabelController;
use App\Http\Controllers\SubSectionController;
use App\Http\Controllers\ModuleController;
use App\Http\Controllers\SectionController;
use App\Http\Controllers\SummaryAssessmentController;
...
Route::middleware(['has_access'])->group(function () {
    ...
    Route::resource('/applabel', AppLabelController::class);
    Route::resource('/module', ModuleController::class);
    Route::resource('/subsection', SubSectionController::class);
    Route::resource('/section', SectionController::class);
    Route::resource('/summary', SummaryAssessmentController::class);
    Route::resource('/logins', AuthOtpController::class);
    Route::resource('/DataBackup', DataBackupController::class);

    //map
    Route::POST('/getLatLong', [App\Http\Controllers\testController::class, 'getLatLong']);
    Route::match(['GET', 'POST'], 'getLatLongFederation', [App\Http\Controllers\FederationController::class, 'getLatLongFederation']);
    Route::match(['GET', 'POST'], 'getLatLongSHG', [App\Http\Controllers\ShgController::class, 'getLatLongSHG']);
    Route::match(['GET', 'POST'], 'getLatLongCluster', [App\Http\Controllers\ClusterController::class, 'getLatLongCluster']);
    Route::match(['GET', 'POST'], 'getLatLongFamily', [App\Http\Controllers\FamilyController::class, 'getLatLongFamily']);
    Route::get('mapDatatable', [App\Http\Controllers\FederationController::class, 'mapDatatable']);
    Route::get('/mapDatatableCluster', [App\Http\Controllers\ClusterController::class , 'mapDatatableCluster']);
    Route::get('/mapDatatableSHG', [App\Http\Controllers\ShgController::class , 'mapDatatableSHG']);
    Route::get('/mapDatatableFamily', [App\Http\Controllers\FamilyController::class , 'mapDatatableFamily']);
    ...
    Route::get('/edit/{module}/{section}/{sub_section}', [App\Http\Controllers\AppLabelController::class , 'edit']);
    ...
    Route::POST('/change_qa_status_fed', [App\Http\Controllers\QualityCheckController::class , 'change_qa_status_fed']);
    Route::POST('/change_qa_status_fm', [App\Http\Controllers\QualityCheckController::class , 'change_qa_status_fm']);
    Route::POST('/change_qa_status_fed1', [App\Http\Controllers\QualityCheckController::class , 'change_qa_status_fed1']);
    ...
    //NRLM CODE CHECK
    Route::get('/check_nrlm_code', [App\Http\Controllers\FederationController::class , 'check_nrlm_code']);
    Route::get('/check_cluster_nrlm_code', [App\Http\Controllers\ClusterController::class , 'check_nrlm_code']);
    Route::get('/check_shg_nrlm_code', [App\Http\Controllers\ShgController::class , 'check_nrlm_code']);
    Route::get('/check_family_member', [App\Http\Controllers\FamilyController::class , 'check_family_member']);
    Route::get('/check_family_spouse', [App\Http\Controllers\FamilyController::class , 'check_family_spouse']);


    // Data export routes
    // family export
    Route::get('/family_export', [App\Http\Controllers\DataExportController::class , 'family']);
    Route::get('/family_export_filter', [App\Http\Controllers\DataExportController::class , 'family']);
    Route::get('/Family_basic_profile', [App\Http\Controllers\DataExportController::class, 'Family_basic_profile']);
    Route::get('/Family_assests', [App\Http\Controllers\DataExportController::class, 'Family_assests']);
    Route::get('/Family_goals', [App\Http\Controllers\DataExportController::class, 'Family_goals']);
    Route::get('/Family_Challenges', [App\Http\Controllers\DataExportController::class, 'Family_Challenges']);
    Route::get('/Family_Observation', [App\Http\Controllers\DataExportController::class, 'Family_Observation']);
    Route::get('/Family_Business', [App\Http\Controllers\DataExportController::class, 'Family_Business']);
    Route::get('/Family_Commitment', [App\Http\Controllers\DataExportController::class, 'Family_Commitment']);
    Route::get('/Family_Agriculture', [App\Http\Controllers\DataExportController::class, 'Family_Agriculture']);
    Route::get('/Family_Horticulture', [App\Http\Controllers\DataExportController::class, 'Family_Horticulture']);
    Route::get('/Family_LiveStock', [App\Http\Controllers\DataExportController::class, 'Family_LiveStock']);
    Route::get('/Family_Loans', [App\Http\Controllers\DataExportController::class, 'Family_Loans']);
    Route::get('/Family_Savings', [App\Http\Controllers\DataExportController::class, 'Family_Savings']);
    Route::get('/Family_Expenditure', [App\Http\Controllers\DataExportController::class, 'Family_Expenditure']);
    Route::get('/Family_income', [App\Http\Controllers\DataExportController::class, 'Family_income']);
    Route::get('/Family_analysis', [App\Http\Controllers\DataExportController::class, 'Family_analysis']);

    // shg export
    Route::get('/shg_export', [App\Http\Controllers\DataExportController::class , 'shg_export']);
    Route::get('/shg_export_filter', [App\Http\Controllers\DataExportController::class , 'shg_export']);
    Route::get('/shg_basic_profile', [App\Http\Controllers\DataExportController::class, 'shg_basic_profile']);
    Route::get('/shg_governance', [App\Http\Controllers\DataExportController::class, 'shg_governance']);
    Route::get('/shg_inclusion_besic', [App\Http\Controllers\DataExportController::class, 'shg_inclusion_besic']);
    Route::get('/shg_inclusion_loans', [App\Http\Controllers\DataExportController::class, 'shg_inclusion_loans']);
    Route::get('/shg_inclusion_hhs_benefitted', [App\Http\Controllers\DataExportController::class, 'shg_inclusion_hhs_benefitted']);
    Route::get('/shg_credit_efficiency_basic', [App\Http\Controllers\DataExportController::class, 'shg_credit_efficiency_basic']);
    Route::get('/shg_credit_efficiency_training', [App\Http\Controllers\DataExportController::class, 'shg_credit_efficiency_training']);
    Route::get('/shg_crecovery_cumulative_loans', [App\Http\Controllers\DataExportController::class, 'shg_crecovery_cumulative_loans']);
    Route::get('/shg_crecovery_hhs_benefitted', [App\Http\Controllers\DataExportController::class, 'shg_crecovery_hhs_benefitted']);
    Route::get('/shg_crecovery_dcb', [App\Http\Controllers\DataExportController::class, 'shg_crecovery_dcb']);
    Route::get('/shg_crecovery_loan_default', [App\Http\Controllers\DataExportController::class, 'shg_crecovery_loan_default']);
    Route::get('/shg_savings', [App\Http\Controllers\DataExportController::class, 'shg_savings']);
    Route::get('/shg_analysis', [App\Http\Controllers\DataExportController::class, 'shg_analysis']);
    Route::get('/shg_challenges_action_plan', [App\Http\Controllers\DataExportController::class, 'shg_challenges_action_plan']);
    Route::get('/shg_observation', [App\Http\Controllers\DataExportController::class, 'shg_observation']);
    Route::get('/shg_ParameterWise_analysis', [App\Http\Controllers\DataExportController::class, 'shg_ParameterWise_analysis']);




    // Cluster
    Route::get('/cluster_export', [App\Http\Controllers\DataExportController::class , 'cluster_export']);
    Route::get('/cluster_export_filter', [App\Http\Controllers\DataExportController::class , 'cluster_export']);
    Route::get('/cluster_basic_profile', [App\Http\Controllers\DataExportController::class , 'cluster_basic_profile']);
    Route::get('/cluster_governance', [App\Http\Controllers\DataExportController::class , 'cluster_governance']);
    Route::get('/cluster_inclusion_basic', [App\Http\Controllers\DataExportController::class , 'cluster_inclusion_basic']);
    Route::get('/cluster_inclusion_loans', [App\Http\Controllers\DataExportController::class , 'cluster_inclusion_loans']);
    Route::get('/cluster_efficiency_basic', [App\Http\Controllers\DataExportController::class , 'cluster_efficiency_basic']);
    Route::get('/cluster_savings', [App\Http\Controllers\DataExportController::class , 'cluster_savings']);
    Route::get('/Cluster_Challenges', [App\Http\Controllers\DataExportController::class , 'Cluster_Challenges']);
    Route::get('/Cluster_sac_training', [App\Http\Controllers\DataExportController::class , 'Cluster_sac_training']);
    Route::get('/Cluster_lead_training', [App\Http\Controllers\DataExportController::class , 'Cluster_lead_training']);
    Route::get('/Cluster_book_training', [App\Http\Controllers\DataExportController::class , 'Cluster_book_training']);
    Route::get('/Cluster_analysis', [App\Http\Controllers\DataExportController::class , 'Cluster_analysis']);
    Route::get('/Cluster_Parameter_analysis', [App\Http\Controllers\DataExportController::class , 'Cluster_Parameter_analysis']);
    Route::get('/cluster_loan_default', [App\Http\Controllers\DataExportController::class , 'cluster_loan_default']);
    Route::get('/cluster_zero_loan', [App\Http\Controllers\DataExportController::class , 'cluster_zero_loan']);
    Route::get('/Cluster_cumulative_loans', [App\Http\Controllers\DataExportController::class , 'Cluster_cumulative_loans']);
    Route::get('/cluster_observation', [App\Http\Controllers\DataExportController::class , 'cluster_observation']);
    Route::get('/cluster_DCB', [App\Http\Controllers\DataExportController::class , 'cluster_DCB']);
    Route::get('/cluster_loan_default', [App\Http\Controllers\DataExportController::class , 'cluster_loan_default']);
    Route::get('/cluster_inclusion_hhs_benefitted', [App\Http\Controllers\DataExportController::class , 'cluster_inclusion_hhs_benefitted']);
    ...
    // federation
    Route::get('/federation_export', [App\Http\Controllers\DataExportController::class , 'federation_export']);
    Route::get('/federation_export_filter', [App\Http\Controllers\DataExportController::class , 'federation_export']);
    Route::get('/federation_basic_profile', [App\Http\Controllers\DataExportController::class, 'federation_basic_profile']);
    Route::get('/federation_governance', [App\Http\Controllers\DataExportController::class, 'federation_governance']);
    Route::get('/federation_governance_traning', [App\Http\Controllers\DataExportController::class, 'federation_governance_traning']);
    Route::get('/federation_inclusion_loans', [App\Http\Controllers\DataExportController::class, 'federation_inclusion_loans']);
    Route::get('/federation_inclusion_hhs_benifitted', [App\Http\Controllers\DataExportController::class, 'federation_inclusion_hhs_benifited']);
    Route::get('/federation_inclusion_basic', [App\Http\Controllers\DataExportController::class, 'federation_inclusion_basic']);
    Route::get('/federation_efficiency', [App\Http\Controllers\DataExportController::class, 'federation_efficiency']);
    Route::get('/federation_credit_history_basic', [App\Http\Controllers\DataExportController::class, 'federation_credit_history_basic']);
    Route::get('/federation_credit_dcb', [App\Http\Controllers\DataExportController::class, 'federation_credit_dcb']);
    Route::get('/federation_credit_loan_default_internate', [App\Http\Controllers\DataExportController::class, 'federation_credit_loan_default_internate']);
    Route::get('/federation_credit_perpose_rotation_vel', [App\Http\Controllers\DataExportController::class, 'federation_credit_perpose_rotation_vel']);
    Route::get('/federation_sustainability', [App\Http\Controllers\DataExportController::class, 'federation_sustainability']);
    Route::get('/federation_risk_migration', [App\Http\Controllers\DataExportController::class, 'federation_risk_migration']);
    Route::get('/federation_challenges_action', [App\Http\Controllers\DataExportController::class, 'federation_challenges_action']);
    Route::get('/federation_observations', [App\Http\Controllers\DataExportController::class, 'federation_observations']);
    Route::get('/federation_analysis', [App\Http\Controllers\DataExportController::class, 'federation_analysis']);
    Route::get('/federation_parameter_wise_analysis', [App\Http\Controllers\DataExportController::class, 'federation_parameter_wise_analysis']);
});
    ...
    Route::get('/get_family_lists', [App\Http\Controllers\CommonController::class , 'get_family_lists']);
    ...
    Route::get('/get_fed_remarks', [App\Http\Controllers\CommonController::class , 'get_fed_remarks']);
    Route::get('/get_cluster_remarks', [App\Http\Controllers\CommonController::class , 'get_cluster_remarks']);
    Route::get('/get_mst_module', [App\Http\Controllers\CommonController::class , 'get_mst_module']);
    Route::get('/get_mst_section', [App\Http\Controllers\CommonController::class , 'get_mst_section']);
    Route::get('/get_mst_sub_section', [App\Http\Controllers\CommonController::class , 'get_mst_sub_section']);
    Route::get('/get_mst_app_label', [App\Http\Controllers\CommonController::class , 'get_mst_app_label']);
    ...
    Route::get('/get_federation_list_id', [App\Http\Controllers\CommonController::class , 'get_federation_list_id']);
    Route::get('/get_family_list_id', [App\Http\Controllers\CommonController::class , 'get_family_list_id']);
    Route::get('/get_fac_list_id', [App\Http\Controllers\CommonController::class , 'get_fac_list_id']);
    Route::get('/get_shg_list_id', [App\Http\Controllers\CommonController::class , 'get_shg_list_id']);
    Route::get('/get_cluster_list_id', [App\Http\Controllers\CommonController::class , 'get_cluster_list_id']);
...
Route::controller(AuthOtpController::class)->group(function(){
    ...
    Route::post('RegenerateOtp', 'regenerate')->name('regenerate');
