...
class FederationAnalysis implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    ...
    public function map($res): array
    {
         ...
         (string)$res['analysis_1'],
         (string)$res['analysis_2'],
         (string)$res['analysis_3'],
         (string)$res['analysis_4'],
         (string)$res['analysis_5'],
         (string)$res['analysis_7'],
         (string)$res['analysis_8'],

         (string)$res['analysis_9'],
         (string)$res['analysis_10'],
         (string)$res['analysis_11'],

         (string)$res['analysis_12'],
         (string)$res['analysis_13'],
         (string)$res['analysis_26'],
         (string)$res['analysis_14'],

         (string)$res['analysis_15'],
         (string)$res['analysis_16'],
         (string)$res['analysis_19'],
         (string)$res['analysis_18'],
         (string)$res['analysis_20'],

         (string)$res['analysis_21'],
         (string)$res['analysis_22'],


         (string)$res['analysis_23'],
         (string)$res['analysis_24'],
         (string)$res['analysis_25'],
    ...
    public function headings(): array
    {
        return [
            ...
            'Rotation of Board members as per norm',
            'Average participation of Board members during last 12 months',
            'Federation books updated as per rules-',
            'Federation Plan & budget approved as per rules by General Assembly',
            'Achievement of last year Plan ',
            'Percent of defunct SHGs in Federation',
            'Last year External Audit completed and issues resolved',

            'Coverage of the poorest and poor as part of total Federation families',
            '% of most poorest and poor families benefitting from all loans (federation and External)',
            'Number of poor/vulnerable and poor families in leadership position',

            'Time taken to approve loan',
            'Cost per active client',
            'Time taken to disburse loan to the member - from approval to cash in hand',
            'Operating expense Ratio',

            '% of members benefited from All loans',
            'Repayment rate of Federation loans during during last 12 months-',
            'Repayment rate of all loans (federation/bank/VI &others) during during last 12 months',
            'PAR status of Federation Loans for 90days-',
            'Yearly rotation of funds in the federation (velocity)',


            'Federation covering its costs',
            'Loan security fund established',


            '% of Memebrs  covered under life insurance',
            ' % of active borrowers covered under life insurance ',
            ' % of asset/animals covered under asset insurance'
