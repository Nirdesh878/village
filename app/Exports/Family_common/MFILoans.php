...
class MFILoans implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fl.lo_type ='MFI Loan' ";
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'MFI LOAN - PRINCIPAL AMOUNT  1',
                'MFI LOAN - PURPOSE 1',
                'MFI LOAN - INTEREST TYPE 1',
                'MFI LOAN - RATE OF INTEREST  1',
                'MFI LOAN - TENURE 1',
                'MFI LOAN - TENURE MODE 1',
                'MFI LOAN - Repayment Start Date  1',
                'MFI LOAN -  Last Repayment date 1',
                'MFI LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'MFI LOAN - OVERDUE AMOUNT  1',
                'MFI LOAN - Next year Loan repayment commitmen  1',
                'MFI LOAN - SPECIFY  1',


                'MFI LOAN - PRINCIPAL AMOUNT 2',
                'MFI LOAN - PURPOSE 2',
                'MFI LOAN - INTEREST TYPE 2',
                'MFI LOAN - RATE OF INTEREST  2',
                'MFI LOAN - TENURE 2',
                'MFI LOAN - TENURE MODE 2',
                'MFI LOAN - Repayment Start Date  2',
                'MFI LOAN -  Last Repayment date 2',
                'MFI LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'MFI LOAN - OVERDUE AMOUNT  2',
                'MFI LOAN - Next year Loan repayment commitmen  2',
                'MFI LOAN - SPECIFY  2',


                'MFI LOAN - PRINCIPAL AMOUNT 3',
                'MFI LOAN - PURPOSE 3',
                'MFI LOAN - INTEREST TYPE 3',
                'MFI LOAN - RATE OF INTEREST  3',
                'MFI LOAN - TENURE 3',
                'MFI LOAN - TENURE MODE 3',
                'MFI LOAN - Repayment Start Date  3',
                'MFI LOAN -  Last Repayment date 3',
                'MFI LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'MFI LOAN - OVERDUE AMOUNT  3',
                'MFI LOAN - Next year Loan repayment commitmen  3',
                'MFI LOAN - SPECIFY  3',
