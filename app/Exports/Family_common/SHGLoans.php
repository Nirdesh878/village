...
class SHGLoans implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'SHG LOAN - PRINCIPAL AMOUNT  1',
                'SHG LOAN - PURPOSE 1',
                'SHG LOAN - INTEREST TYPE 1',
                'SHG LOAN - RATE OF INTEREST  1',
                'SHG LOAN - TENURE 1',
                'SHG LOAN - TENURE MODE 1',
                'SHG LOAN - Repayment Start Date  1',
                'SHG LOAN -  Last Repayment date 1',
                'SHG LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'SHG LOAN - OVERDUE AMOUNT  1',
                'SHG LOAN - Next year Loan repayment commitmen  1',
                'SHG LOAN - SPECIFY  1',


                'SHG LOAN - PRINCIPAL AMOUNT 2',
                'SHG LOAN - PURPOSE 2',
                'SHG LOAN - INTEREST TYPE 2',
                'SHG LOAN - RATE OF INTEREST  2',
                'SHG LOAN - TENURE 2',
                'SHG LOAN - TENURE MODE 2',
                'SHG LOAN - Repayment Start Date  2',
                'SHG LOAN -  Last Repayment date 2',
                'SHG LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'SHG LOAN - OVERDUE AMOUNT  2',
                'SHG LOAN - Next year Loan repayment commitmen  2',
                'SHG LOAN - SPECIFY  2',


                'SHG LOAN - PRINCIPAL AMOUNT 3',
                'SHG LOAN - PURPOSE 3',
                'SHG LOAN - INTEREST TYPE 3',
                'SHG LOAN - RATE OF INTEREST  3',
                'SHG LOAN - TENURE 3',
                'SHG LOAN - TENURE MODE 3',
                'SHG LOAN - Repayment Start Date  3',
                'SHG LOAN -  Last Repayment date 3',
                'SHG LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'SHG LOAN - OVERDUE AMOUNT  3',
                'SHG LOAN - Next year Loan repayment commitmen  3',
                'SHG LOAN - SPECIFY  3',
