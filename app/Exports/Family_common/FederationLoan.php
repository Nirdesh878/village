...
class FederationLoan implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fl.lo_type ='Federation Loan' ";
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'FEDERATION LOAN - PRINCIPAL AMOUNT  1',
                'FEDERATION LOAN - PURPOSE 1',
                'FEDERATION LOAN - INTEREST TYPE 1',
                'FEDERATION LOAN - RATE OF INTEREST  1',
                'FEDERATION LOAN - TENURE 1',
                'FEDERATION LOAN - TENURE MODE 1',
                'FEDERATION LOAN - Repayment Start Date  1',
                'FEDERATION LOAN -  Last Repayment date 1',
                'FEDERATION LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'FEDERATION LOAN - OVERDUE AMOUNT  1',
                'FEDERATION LOAN - Next year Loan repayment commitmen  1',
                'FEDERATION LOAN - SPECIFY  1',


                'FEDERATION LOAN - PRINCIPAL AMOUNT 2',
                'FEDERATION LOAN - PURPOSE 2',
                'FEDERATION LOAN - INTEREST TYPE 2',
                'FEDERATION LOAN - RATE OF INTEREST  2',
                'FEDERATION LOAN - TENURE 2',
                'FEDERATION LOAN - TENURE MODE 2',
                'FEDERATION LOAN - Repayment Start Date  2',
                'FEDERATION LOAN -  Last Repayment date 2',
                'FEDERATION LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'FEDERATION LOAN - OVERDUE AMOUNT  2',
                'FEDERATION LOAN - Next year Loan repayment commitmen  2',
                'FEDERATION LOAN - SPECIFY  2',


                'FEDERATION LOAN - PRINCIPAL AMOUNT 3',
                'FEDERATION LOAN - PURPOSE 3',
                'FEDERATION LOAN - INTEREST TYPE 3',
                'FEDERATION LOAN - RATE OF INTEREST  3',
                'FEDERATION LOAN - TENURE 3',
                'FEDERATION LOAN - TENURE MODE 3',
                'FEDERATION LOAN - Repayment Start Date  3',
                'FEDERATION LOAN -  Last Repayment date 3',
                'FEDERATION LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'FEDERATION LOAN - OVERDUE AMOUNT  3',
                'FEDERATION LOAN - Next year Loan repayment commitmen  3',
                'FEDERATION LOAN - SPECIFY  3',
