...
class Horticulture implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fa.production_type ='Horticultural'  ";
        ...
        $query .= "SELECT
         agriculture,
             ...
             fa_total_land_owned,
              ...
              COALESCE(SUM(total_sale_value),0) AS total_sale
