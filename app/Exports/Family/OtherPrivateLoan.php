...
class OtherPrivateLoan implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fl.lo_type ='Other Private Loan' ";
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'OTHER PRIVATE LOAN - PRINCIPAL AMOUNT  1',
                'OTHER PRIVATE LOAN - PURPOSE 1',
                'OTHER PRIVATE LOAN - INTEREST TYPE 1',
                'OTHER PRIVATE LOAN - RATE OF INTEREST  1',
                'OTHER PRIVATE LOAN - TENURE 1',
                'OTHER PRIVATE LOAN - TENURE MODE 1',
                'OTHER PRIVATE LOAN - Repayment Start Date  1',
                'OTHER PRIVATE LOAN -  Last Repayment date 1',
                'OTHER PRIVATE LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'OTHER PRIVATE LOAN - OVERDUE AMOUNT  1',
                'OTHER PRIVATE LOAN - Next year Loan repayment commitmen  1',
                'OTHER PRIVATE LOAN - SPECIFY  1',


                'OTHER PRIVATE LOAN - PRINCIPAL AMOUNT 2',
                'OTHER PRIVATE LOAN - PURPOSE 2',
                'OTHER PRIVATE LOAN - INTEREST TYPE 2',
                'OTHER PRIVATE LOAN - RATE OF INTEREST  2',
                'OTHER PRIVATE LOAN - TENURE 2',
                'OTHER PRIVATE LOAN - TENURE MODE 2',
                'OTHER PRIVATE LOAN - Repayment Start Date  2',
                'OTHER PRIVATE LOAN -  Last Repayment date 2',
                'OTHER PRIVATE LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'OTHER PRIVATE LOAN - OVERDUE AMOUNT  2',
                'OTHER PRIVATE LOAN - Next year Loan repayment commitmen  2',
                'OTHER PRIVATE LOAN - SPECIFY  2',


                'OTHER PRIVATE LOAN - PRINCIPAL AMOUNT 3',
                'OTHER PRIVATE LOAN - PURPOSE 3',
                'OTHER PRIVATE LOAN - INTEREST TYPE 3',
                'OTHER PRIVATE LOAN - RATE OF INTEREST  3',
                'OTHER PRIVATE LOAN - TENURE 3',
                'OTHER PRIVATE LOAN - TENURE MODE 3',
                'OTHER PRIVATE LOAN - Repayment Start Date  3',
                'OTHER PRIVATE LOAN -  Last Repayment date 3',
                'OTHER PRIVATE LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'OTHER PRIVATE LOAN - OVERDUE AMOUNT  3',
                'OTHER PRIVATE LOAN - Next year Loan repayment commitmen  3',
                'OTHER PRIVATE LOAN - SPECIFY  3',
    ...
    {
        return 'Family Other Private Loan';
    }
}
