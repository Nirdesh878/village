...
class OtherExpenditure implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
        ...
        f.id,
          ...
          (COALESCE(fl.loan_ex,0)+COALESCE(fs.saving_total,0)) AS total
    ...
    {
        return 'Loan & Savings Expenditure';
    }
}
