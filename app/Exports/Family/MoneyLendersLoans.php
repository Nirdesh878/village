...
class MoneyLendersLoans implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fl.lo_type ='Money Lenders Loan' ";
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'MONEY LENDERS LOAN - PRINCIPAL AMOUNT  1',
                'MONEY LENDERS LOAN - PURPOSE 1',
                'MONEY LENDERS LOAN - INTEREST TYPE 1',
                'MONEY LENDERS LOAN - RATE OF INTEREST  1',
                'MONEY LENDERS LOAN - TENURE 1',
                'MONEY LENDERS LOAN - TENURE MODE 1',
                'MONEY LENDERS LOAN - Repayment Start Date  1',
                'MONEY LENDERS LOAN -  Last Repayment date 1',
                'MONEY LENDERS LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'MONEY LENDERS LOAN - OVERDUE AMOUNT  1',
                'MONEY LENDERS LOAN - Next year Loan repayment commitmen  1',
                'MONEY LENDERS LOAN - SPECIFY  1',


                'MONEY LENDERS LOAN - PRINCIPAL AMOUNT 2',
                'MONEY LENDERS LOAN - PURPOSE 2',
                'MONEY LENDERS LOAN - INTEREST TYPE 2',
                'MONEY LENDERS LOAN - RATE OF INTEREST  2',
                'MONEY LENDERS LOAN - TENURE 2',
                'MONEY LENDERS LOAN - TENURE MODE 2',
                'MONEY LENDERS LOAN - Repayment Start Date  2',
                'MONEY LENDERS LOAN -  Last Repayment date 2',
                'MONEY LENDERS LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'MONEY LENDERS LOAN - OVERDUE AMOUNT  2',
                'MONEY LENDERS LOAN - Next year Loan repayment commitmen  2',
                'MONEY LENDERS LOAN - SPECIFY  2',


                'MONEY LENDERS LOAN - PRINCIPAL AMOUNT 3',
                'MONEY LENDERS LOAN - PURPOSE 3',
                'MONEY LENDERS LOAN - INTEREST TYPE 3',
                'MONEY LENDERS LOAN - RATE OF INTEREST  3',
                'MONEY LENDERS LOAN - TENURE 3',
                'MONEY LENDERS LOAN - TENURE MODE 3',
                'MONEY LENDERS LOAN - Repayment Start Date  3',
                'MONEY LENDERS LOAN -  Last Repayment date 3',
                'MONEY LENDERS LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'MONEY LENDERS LOAN - OVERDUE AMOUNT  3',
                'MONEY LENDERS LOAN - Next year Loan repayment commitmen  3',
                'MONEY LENDERS LOAN - SPECIFY  3',
                ''
    ...
    {
        return 'Family Money Lenders Loan';
    }
}
