...
class LiveStock implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fa.production_type ='Live Stock'  ";
        ...
        $query .= "SELECT
         agriculture,
             ...
             name_of_federation,
             analysis_rating,
              MAX(CASE WHEN agriculture = 1 THEN production_sub_type END) AS production_sub_type1,
              ...
              MAX(CASE WHEN agriculture = 2 THEN production_sub_type END) AS production_sub_type2,
              ...
              MAX(CASE WHEN agriculture = 3 THEN production_sub_type END) AS production_sub_type3,
