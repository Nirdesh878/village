...
class BankLoan implements WithHeadings, ShouldAutoSize, WithEvents, WithTitle, FromCollection, WithColumnFormatting, WithMapping
{
    public $curdate = '';
    public $counter = 1;
    ...
    public function collection()
    {
	 ...
	 WHERE  s.is_deleted = 0 AND f.is_deleted = 0 AND fl.lo_type ='Bank Loan' ";
    ...
    public function headings(): array
    {
        return [
            ...
            [
                ...
                'BANK LOAN - PRINCIPAL AMOUNT  1',
                'BANK LOAN - PURPOSE 1',
                'BANK LOAN - INTEREST TYPE 1',
                'BANK LOAN - RATE OF INTEREST  1',
                'BANK LOAN - TENURE 1',
                'BANK LOAN - TENURE MODE 1',
                'BANK LOAN - Repayment Start Date  1',
                'BANK LOAN -  Last Repayment date 1',
                'BANK LOAN - TOTAL CUMULATIVE REPAID AMOUNT  1',
                'BANK LOAN - OVERDUE AMOUNT  1',
                'BANK LOAN - Next year Loan repayment commitmen  1',
                'BANK LOAN - SPECIFY  1',


                'BANK LOAN - PRINCIPAL AMOUNT 2',
                'BANK LOAN - PURPOSE 2',
                'BANK LOAN - INTEREST TYPE 2',
                'BANK LOAN - RATE OF INTEREST  2',
                'BANK LOAN - TENURE 2',
                'BANK LOAN - TENURE MODE 2',
                'BANK LOAN - Repayment Start Date  2',
                'BANK LOAN -  Last Repayment date 2',
                'BANK LOAN - TOTAL CUMULATIVE REPAID AMOUNT  2',
                'BANK LOAN - OVERDUE AMOUNT  2',
                'BANK LOAN - Next year Loan repayment commitmen  2',
                'BANK LOAN - SPECIFY  2',


                'BANK LOAN - PRINCIPAL AMOUNT 3',
                'BANK LOAN - PURPOSE 3',
                'BANK LOAN - INTEREST TYPE 3',
                'BANK LOAN - RATE OF INTEREST  3',
                'BANK LOAN - TENURE 3',
                'BANK LOAN - TENURE MODE 3',
                'BANK LOAN - Repayment Start Date  3',
                'BANK LOAN -  Last Repayment date 3',
                'BANK LOAN - TOTAL CUMULATIVE REPAID AMOUNT  3',
                'BANK LOAN - OVERDUE AMOUNT  3',
                'BANK LOAN - Next year Loan repayment commitmen  3',
                'BANK LOAN -SPECIFY  3',
