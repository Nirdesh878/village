    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            ...
            foreach ($familys as $family) {
                ...
                if ($family->family_flag == 1 && $family->family_buisness == 1) {
                    $row[] = '<div style="background-color:violet; font-weight:bold; height:100%; width:92%; padding:8px;">' . $family->uin . '</div>';
                } else if ($family->family_flag == 1) {
                    $row[] = '<div style="background-color:lightblue; font-weight:bold; height:100%; width:92%; padding:8px;">' . $family->uin . '</div>';
                } else {
                    $row[] = $family->uin;
                }                     
