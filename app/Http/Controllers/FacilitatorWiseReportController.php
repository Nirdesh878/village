...
class FacilitatorWiseReportController extends Controller
{
    ...
    public function get_task_assignment_details(Request $request)
    {
        ...
        <th colspan="12" style="text-align:center; font-size:20px;"> ' . $name . ' </th>
        </thead>
        <thead class="back-color">
        <tr>
            <th>S.No</th>
        ...
        if (request()->ajax()) {
            if ($request->get('userID') != '') {
                ...
                b.updated_at,
                b.updated_task,
                e.name_of_federation as task_name
            ...
            SELECT
                ...
                b.updated_at,
                b.updated_task,
                e.name_of_cluster as task_name
            FROM
                cluster_mst a
            INNER JOIN cluster_sub_mst d ON
                a.id = d.cluster_mst_id
